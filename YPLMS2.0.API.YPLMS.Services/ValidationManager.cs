...
namespace YPLMS2._0.API.YPLMS.Services
{
    ...
    public class ValidationManager
    {
        ...
        //-aw LCP-23417  Allow foreign characters.   ////Chnaged by shrihari
        public const string ALPHANUMERIC_UNICODE_VALIDATION_EXPRESSION = @"^[\u0021-\u007E\u00A1-\u00AC\u00AE-\u00FF\u4E00-\u9FA5\u0E01-\u0E5B\\udf00-\udf5e\p{Ll}\p{Lu}\p{Lo}a-zA-Z0-9 `~!@#$%^&*()_=+{}®™©–‘’“”—[|\;:""',./\?\]-]*$";
            //// @"^[\p{Ll}\p{Lu}\p{Lo}a-zA-Z0-9 `~!@#$%^&*()_=+{}®™©–‘’“”—[|\;:""',./\?\]-]*$";

        //-aw LCP-23417  Allow foreign characters.
        public const string ALPHABETICAL_UNICODE_VALIDATION_EXPRESSION = @"^[\u0021-\u007E\u00A1-\u00AC\u00AE-\u00FF\u4E00-\u9FA5\u0E01-\u0E5B\\udf00-\udf5e\p{Ll}\p{Lu}\p{Lo}0-9 @\""';,.]+$";

        /// <summary>
        /// const string EmailID Validation Expression
        /// </summary>
        //public const string EMAILID_VALIDATION_EXPRESSION = @"^[!a-zA-Z0-9/./-/'+--]*[\w\./-/'+--]*[a-zA-Z0-9/./-/'+--]@[a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z]$";
        // New regex to include .before @ symbol by Prajakta
        ...
        public static string RemoveSpecialCharsForNameAndDescription(string str)
        {
