    ...
    public class Converter
    {
        ...
        public  List<T> ConvertDataTableToList<T>(DataTable dataTable) where T : new()
        {
            try
            {
                ...
                // Get the properties of the class (type T)
                ...
                foreach (DataRow row in dataTable.Rows)
                {
                    ...
                    foreach (PropertyInfo property in properties)
                    {
                        ...
                        {
                            // If the value in the DataTable is not DBNull, set it to the object property
                            if (row[property.Name] != DBNull.Value)
                            {
                                if (property.PropertyType.IsEnum)
                                {
                                    // Convert string to enum
                                    string value = row[property.Name].ToString();
