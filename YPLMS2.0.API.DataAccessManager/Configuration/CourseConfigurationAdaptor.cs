...
namespace YPLMS2._0.API.DataAccessManager
{
    ...
    public class CourseConfigurationAdaptor : IDataManager<CourseConfiguration>, ICourseConfigurationAdaptor<CourseConfiguration>
    {
        ...
        string _strMessageId = YPLMS.Services.Messages.CourseConfiguration.ERROR_MSG_ID;
        ...
        private CourseConfiguration Update(CourseConfiguration pEntCourseConfiguration, string pUpdateMode)
        {
            ...
            try
            {
                ...
                if (pUpdateMode == Schema.Common.VAL_INSERT_MODE)
                {
                    ...
                    pEntCourseConfiguration.ID = YPLMS.Services.IDGenerator.GetStringGUID();
                }
                else
