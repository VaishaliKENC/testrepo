        ...
        public ContentModule Execute(ContentModule pEntContModule, ContentModule.Method pMethod)
        {
            ...
            switch (pMethod)
            {
                ...
                case ContentModule.Method.Get:
                    ...
                    break;
                case ContentModule.Method.CheckLockCourseAssessment:
                    entContModuleReturn = adaptorContModule.CheckLockCourseAssessment(pEntContModule);
                    break;
                ...
                case ContentModule.Method.UpdateCourseDetails:
                    entContModuleReturn = adaptorContModule.UpdateCourseDetails(pEntContModule);
                    break;
                //
                case ContentModule.Method.SearchContentModuleURL:
                    entContModuleReturn = adaptorContModule.SearchContentModuleURL(pEntContModule);
                    break;
                default:
