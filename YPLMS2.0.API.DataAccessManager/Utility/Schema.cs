...
* Encora's Client.
* Author:Fattesinh, Ashish, Shailesh
* Created:01/07/09
* Last Modified:<16/07/09>
*/

namespace YPLMS2._0.API.DataAccessManager.Schema
{
    #region AppSettings
    ...
    public class AppSettings
    {
        ...
        /// </summary>
        public const string APP_SET_MASTERDB_CONN = "learningComponentsConnnectionString";
    }
    #endregion

    public class StandardReportSP
    {
        public const string PROC_GROUPWISEASSIGNMENTS_COMPLETIONGRAPH = "sproc_GroupwiseAssignments_CompletionGraph";
        public const string PROC_MOSTPURCHASED_CATALOGUES = "sproc_MostPurchasedCatalogues";
        public const string PROC_ACTIVITY_COMPLETIONGRAPH_DASHBOARD = "sproc_Activity_CompletionGraph_Dashboard";
        public const string PROC_RECENTLYACCESSEDACTIVITY_COMPLETIONGRAPH = "sproc_RecentlyAccessedActivity_CompletionGraph";
        ...
        public const string COURSE_ASSESSMENT_INTERACTION_TRACKING = "sproc_Report_CourseAssessment_InteractionTracking";
        public const string ASSIGNED_USERS_BY_ACTIVITY_STATUS_ALL = "sproc_Report_AssignedUsersByActivityStatus_All";
        public const string ASSIGNED_USERS_BY_ACTIVITY_STATUS_NEW = "sproc_Report_AssignedUsersByActivityStatus";
        public const string CURRICULUM_DETAILS_REPORT = "sproc_Report_Curriculum_Details";
        public const string MODULE_REPORT = "sproc_Report_Module_Details";
        public const string MODULE_TRAININGATTENDANCEREPORT = "sproc_Report_TrainingAttendance";
        public const string PROC_GET_USERWISEILTREPORT = "sproc_Report_User_Wise_ILT_Details";
        ...
        public const string PROC_EVENT_DETAIL_REPORT = "sproc_Report_ILTEventDetails";
        public const string PROC_SESSION_DETAIL_REPORT = "sproc_Report_ILTSessionDetails";
        //-- Dashboard
        ...
        //Added for Certified Trainer
        public const string PROC_USER_CERTIFIED_TRAINING_COURSES_DASHBOARD = "sproc_UserCertifiedTrainingPrograms_sel_ByLearner_NotCompleted_Dashboard";
        public const string PROC_USER_CERTIFIED_TRAINING_COURSES_MAINPAGE = "sproc_UserCertifiedTrainingPrograms_sel_ByLearner_NotCompleted_MainPage";
        ...
        public const string PROC_USERCONTENTMODULETRACKING_LSTALL_MOH = "sproc_UserContentModuleTracking_LstAll_MOH";
        public const string PROC_GETUSERS_SUBSCRIBE_FORNEWSLETTER = "sproc_GetUsersSubScribe_ForNewsLetter";
        public const string PROC_ABANDONED_CART_REPORT = "sproc_AbandonedCartReport";
        public const string PROC_PRODUCT_DETAIL_REPORT = "sproc_ProductDetailReport";
    ...
    public class Client
    {
        ...
        public const string PROC_CREATE_CLUSTER_FOR_NEWCLIENT = "sproc_CreateClusterForNewClient";
        ...
        public const string PROC_UPDATE_AUDITTRAILPERIOD = "sproc_SetAuditTrailPeriod_SysConfig";
        public const string PROC_GET_AUDITTRAILPERIOD = "sproc_GetAuditTrailPeriod_SysConfig";
        public const string PROC_GET_JIRAHELPDESK = "sproc_GetJIRAHelpDesk_SysConfig";
        public const string PROC_GET_GETDOCLICENSEPATH = "sproc_GetDocLicensePath_SysConfig";


        //PARAMETERS

        public const string PARA_AUDITTRAILPERIOD = "@AuditTrailPeriod";
        ...
        public const string PARA_YPLS_DEFAULT_LAYOUT_ID = "@YPLSLayoutId";
        public const string PARA_YPLS_DEFAULT_THEME_ID = "@YPLSThemeId";

        public const string COL_YPLS_DEFAULT_LAYOUT_ID = "YPLSLayoutId";
        public const string COL_YPLS_DEFAULT_THEME_ID = "YPLSThemeId";
        /// <summary>
        /// COL_CLIENT_ID
        /// </summary>
        ...
        public const string COL_SMTP_PORT = "SMTPPort";
        public const string COL_SMTP_ENABLESSL = "SMTPEnableSSL";
        public const string COL_SECURITY_PROTOCOL = "SecurityProtocol";
    ...
    public class ClientFeature
    {
        ...
        public const string PROC_ISYPTAB_IPerform_Key_Exist = "sproc_IsYPTab_Iperform_Key_Exist";
        public const string PROC_ISYPTAB_Key_Exist = "sproc_IsYPTab_Key_Exist";
        public const string PROC_IPerform_Key_Exist = "sproc_Iperform_Key_Exist";

        public const string PROC_GETYPTAB_IPerform_Key = "sproc_GetYPTab_Iperform_Key";
        //PARAMETERS
        ...
        public const string PARA_PUPPORTALCUSTOMFILDS = "@PubPortalCustomFields";

        public const string PARA_IperFormRegKey = "@IperFormRegKey";
        public const string PARA_YPTabRegKey = "@YPTabRegKey";
        public const string PARA_IPerformDBName = "@IPerformDBName";
    ...
    */
    ...
    public class ThemeLanguages
    {
        ...
        public const string COL_CSS_FILENAME_11 = "CSSFileName11";
        public const string COL_CSS_FILENAME_12 = "CSSFileName12";
        public const string COL_CSS_FILENAME_13 = "CSSFileName13";
        public const string COL_CSS_FILENAME_14 = "CSSFileName14";
        public const string COL_CSS_FILENAME_15 = "CSSFileName15";
        public const string COL_CSS_FILENAME_16 = "CSSFileName16";
        public const string COL_CSS_FILENAME_17 = "CSSFileName17";
        public const string COL_CSS_FILENAME_18 = "CSSFileName18";
        public const string COL_CSS_FILENAME_19 = "CSSFileName19";
        public const string COL_CSS_FILENAME_20 = "CSSFileName20";
    }
    #endregion
    ...
    public class Configuration
    {
        ...
        public const string COL_AUDITTRAILPERIOD = "AuditTrailPeriod";
        public const string COL_JIRAHELPDESKPROJECTID = "JiraHelpDeskProjectId";
        public const string COL_JIRAHELPDESKREQUESTTYPE = "JiraHelpDeskRequestType";
        public const string COL_DOCLICENSEPATH = "GroupDocLicensePath";
        public const string COL_RECIPIENTEMAILID = "RecipientEmailId";
        public const string COL_GWTCADATABASENAME = "GWTCADatabaseName";
    ...
    */
    ...
    public class OTP
    {
        public const string PROC_GET_OTP = "sproc_OTP_sel";
        public const string PROC_ADDUPDATE_OTP = "sproc_AddUpdateOTP";
        public const string PROC_CHECK_OTP_EXPIRE = "sproc_Check_OTP_Expire";
        public const string PROC_GET_OTP_NUMBER = "sproc_Get_OTP_Number";

        //PARAMETERS
        public const string PARA_OTP_ID = "@OTPID";
        public const string PARA_SYSTEMUSERGUID = "@SystemUserGuid";
        public const string PARA_OTP_NUMBER = "@OTPNumber";
        public const string PARA_EXPIRE_DATETIME = "@ExpireDateTime";
        //FIELDS
        public const string COL_OTP_ID = "OTPID";
        public const string COL_SYSTEMUSERGUID = "SystemUserGuid";
        public const string COL_OTP_NUMBER = "OTPNumber";
        public const string COL_EXPIRE_DATETIME = "ExpireDateTime";
    }
    #endregion
    ...
    public class Learner
    {
        ...
        public const string PROC_GET_USER_SELF_REGI = "sproc_UserMaster_sel_SelfRegi";
        public const string PROC_GET_USER_COURSE_PLAYER = "sproc_UserMaster_sel_CoursePlayer";
        ...
        public const string PROC_GET_USER_STUDENT_REGI_APPROVED = "sproc_UserMaster_sel_StudentRegiApproved";
        public const string PROC_SEARCH_REGIONAL_ADMINS = "sproc_UserMaster_Sel_RegionalAdmins";
        public const string PROC_UPDATE_USER = "sproc_UserMaster_ups";
        public const string PROC_UPDATE_USER_REGI_STATUS = "sproc_UserMaster_ups_RegiStatus";
        public const string PROC_UPDATE_PPUSER = "sproc_UserMasterPubPortal_ups";
        ...
        public const string PROC_GET_USER_BY_ALIAS_ILT = "sproc_ILTUserMaster_selByAlias";
        ...
        public const string PROC_GET_USER_BY_SYSTEMUSERGUID = "sproc_UserMaster_selBy_SystemUserGUID";
        ...
        public const string PROC_FIND_USERS_SELF_REGI_LIST = "sproc_UserMaster_Sel_SelfRegiList";
        ...
        public const string PROC_SEARCH_LEARNERS_ForIPerform = "sproc_UserMaster_Sel_dtls_forIPerform";
        public const string PROC_CHECK_NEW_PWD = "sproc_CheckNewPassword";
        public const string PORC_CHECKSETNEWPASSWORD = "sproc_CheckSetNewPassword";
        ...
        public const string PROC_SEARCH_LEARNERS_FOR_UNLOCKASSIGNMENTS = "sproc_UserMaster_Sel_LockAssignment";
        ...
        public const string PROC_UPDATE_USER_STUDENT_DETAILS = "sproc_UserMaster_ups_StudentDetails";
        ...
        public const string PROC_BULK_RESET_PASSWORD = "sproc_UserMaster_ups_ResetPassword";
        ...
        public const string PROC_USER_LOCK_UNLOCK_OTP = "sproc_UserLock_Unlock_OTP";
        public const string PROC_GET_USER_SYSTEMUSERGUID = "sproc_ToGetSystemUserGUID";
        public const string PROC_GET_IS_USER_LOCK = "sproc_ToGetIsUserLock";
        public const string PROC_GET_OTP_NUMBER = "sproc_ToGetOTPNumber";

        public const string PROC_UPDATE_TERMS_AND_CONDITION = "sproc_Terms_Condition_Checked_by_User";

        public const string PROC_Add_SubscriptionOfUser_ForNewsLetter = "sproc_Add_SubscriptionOfUser_ForNewsLetter";
        public const string PROC_GETUSERS_Subscribe_ForNewsLetter = "sproc_GetUsersSubScribe_ForNewsLetter";
        public const string PROC_GET_USER_ISACTIVE_BY_EMAIL = "sproc_UserMaster_IsActive_selBy_EmailId";

        public const string PROC_SEARCH_LEARNERS_FOR_ATTEMPTUNLOCKASSIGNMENTS = "sproc_UserMaster_Sel_AttemptLockAssignment";
        public const string PROC_SAVE_SELECTED_USER_FOR_ONETIMEASSIGNMENT = "sproc_SelectedUserForOnetimeAssignment_ups";
        public const string PROC_DELETE_SELECTED_USER_FOR_ONETIMEASSIGNMENT = "sproc_SelectedUserForOnetimeAssignment_del";
        public const string PROC_GET_USERS_BY_REQUESTEDID = "sproc_SelectedUserForOnetimeAssignment_sel";
        ...
        public const string PROC_SELECTED_BUSSINESS_RULE_USERS = "sproc_Seleted_Bussiness_Rule_Users";

        //PARAMETERS
        public const string PARA_OTP_NUMBER = "@OTPNumber";
        public const string PARA_PP_CUSTOMFIELDS = "@PublishingPortalCustomFields";
        ...
        public const string PARA_STUDENTS_DETAIL_ID = "@StudentDetailsId";
        public const string PARA_STUDENTS_IDPROOFDOCUMENT = "@IdProofDocument";
        public const string PARA_STUDENTS_REGISTRATION_STATUS = "@RegistrationStatus";
        ...
        public const string PARA_LEARNER_TYPE = "@LearnerType";
        public const string PARA_STUDENTID_PROOF = "@StudentIdProof";
        ...
        public const string PARA_IS_USER_LOCK = "@IsUserLock";
        public const string PARA_REGISTRATION_STATUS = "@RegistrationStatus";
        public const string PARA_REJECT_COMMENTS = "@RejectComments";
        public const string PARA_IS_USER_SIGNUP = "@IsUserSignUp";
        public const string PARA_LEARNER_NAME = "@LearnerName";
        ...
        public const string COL_AUTHENTICATION_TOKEN = "PPAuthenticationToken";  //added by sujata 26/11/2015..get PPAuthenticationtoken
        ...
        public const string COL_IS_USER_LOCK = "IsUserLock";
        public const string COL_REGISTRATION_STATUS = "RegistrationStatus";
        public const string COL_IDPROOFDOCUMENT = "IdProofDocument";
        public const string COL_REJECTCOMMENTS = "RejectComments";
        public const string COL_ISTERMSANDCONDACCEPTED = "IsTermsAndCondAccepted";
        public const string COL_ILT_ROLE_COUNT = "ILTRoleCount";
    ...
    public class ActivityAssignment
    {
        ...
        public const string PROC_GET_LEARNER_ASSIGNMENT_PRINT_ALL = "sproc_UserActivityAssignment_ByLearner_Print_ALL";
        ...
        public const string PROC_SEARCH_ACTIVITY_COURSEASSESSMENT_INTERACTIONTRACKING = "sproc_Activity_Search_CourseAssessment InteractionTracking";
        ...
        public const string PROC_GET_LEARNER_USERS = "sproc_UserActivityAssignment_ByUsers";
        public const string PROC_UPDATE_ACTIVITY_ASSIGN_RERGISTER = "sproc_UserActivityAssignment_ups_ReRegister";

        public const string PROC_USERActivitySearch_ForBulkImport = "sproc_UserActivitySearch_ForBulkImport";
        public const string PROC_GET_LEARNER_ASSIGNMENT_FOR_EDIT = "sproc_UserActivityAssignment_sel_ByLearner_ForEdit";
        public const string PROC_GET_LEARNER_ASSIGNMENT_FOR_UNLOCK = "sproc_UserActivityAssignment_sel_ByLearner_ForUnlock";
        public const string PROC_GET_LEARNER_ASSIGNMENT_FOR_ATTEMPTUNLOCK = "sproc_UserActivityAssignment_sel_ByLearner_ForAttemptUnlock";
        ...
        public const string SEND_ASSIGNMENT_FOR_CERTIFICATION_APPROVAL = "sproc_UserActivityAssignment_sel_ByLearner_ForAttemptUnlock";
        ...
        public const string PROC_GET_CURRENT_ATTEMTPS_MAXSCORECOURSE = "sproc_UserActivityAttempts_LstAll_CourseMaxScore";
        ...
        public const string PROC_SEARCH_ACTIVITY_BY_UNIFIED_ACTIVITY_MAPPING = "sproc_Activity_Search_ByUnifiedActivityMapping";

        public const string PROC_SEARCH_ACTIVITY_BY_Activity_Certificate_MAPPING = "sproc_Activity_Search_ByActivityCertificateMapping";
        ...
        public const string PROC_GET_LEARNER_ASSIGNMENT_FOR_DL = "sproc_UserActivityAssignment_LstAll_FOR_DL";
        public const string PROC_GetVirtualClassroomNominationDetailsDuringOneTimeAssignment = "sproc_GetVirtualClassroomNominationDetailsDuringOneTimeAssignment";
        public const string PROC_SEARCH_ACTIVITY_ONETIMEASSIGNMENT_FORCURRICULUM = "sproc_Activity_SearchOneTimeAssignment_ForCurriculum";
        public const string PROC_DELETE_VTANDCTATTIMEOD_EDITASSIGNMENT = "sproc_DeleteVTAndCTRecordsAtTimeOfEditAssignment";

        public const string PROC_GetVirtualClassroomNominationRegistrationCountOneTimeAssignment = "sproc_IsRegistrationCountExceedForVTAndCT_ForCurriculum";
        public const string PROC_ASSIGNMENT_FOR_CERTIFCATIONAPPROVAL = "sproc_SendAssignment_For_CertificationApproval";
        public const string PROC_ASSIGNMENT_FOR_CERTIFCATIONAPPROVAL_FROM_LEARNER = "sproc_SendAssignment_For_CertificationApproval_FromLearner";
        public const string PROC_UPDATE_FOR_CERTIFCATIONAPPROVAL = "sproc_UpdateCertificationProgram_ApproveReject";
        public const string PROC_SAVE_SELETED_ACTIVITY_FOR_ONETIMEASSIGNMENT = "sproc_ActivitySelectedForOnetimeAssignment_ups";
        public const string PROC_DELETE_SELETED_ACTIVITY_FOR_ONETIMEASSIGNMENT = "sproc_ActivitySelectedForOnetimeAssignment_del";
        public const string PROC_GET_SELECTED_ACTIVITY = "sproc_SelectedActivityForOnetimeAssignment_sel";
        ...
        public const string PARA_IS_ACTIVITY_OR_CATEGORY = "@IsActivityCategory";
        ...
        public const string PARA_OPERATIONMODE_REASSIGNMENT_FORBULK = "@OperationMode";
        ...
        public const string PARA_UserIdList = "@UserIdList";

        //For Certification Programs
        public const string PARA_CER_PROGRAM_IS_APPROVED = "@IsApproved";
        public const string PARA_CER_PROGRAM_IS_REJECTED = "@IsRejected";
        public const string PARA_IS_FOR_ADMIN_PREVIEW = "@IsForAdminPreview";
      //  public const string PARA_IS_CERTIFICATION_PROGRAM = "@IsCertificationProgram";
        public const string PARA_CPID = "@CpId";
        public const string PARA_ID = "@Id";
        ...
        public const string COL_IS_ACTIVITY_OR_CATEGORY = "IsActivityCategory";
        ...
        public const string COL_OPERATIONMODE_REASSIGNMENT_FORBULK = "OperationMode";
        ...
        //For Certification Programs
        public const string COL_CER_PROGRAM_IS_APPROVED = "IsApproved";
        public const string COL_CER_PROGRAM_IS_REJECTED = "IsRejected";
        public const string COL_IS_FOR_ADMIN_PREVIEW = "IsForAdminPreview";
      //  public const string COL_IS_CERTIFICATION_PROGRAM = "IsCertificationProgram";
        public const string COL_CPID = "CPid";
        public const string COL_ID = "Id";
    }
    #endregion
    ...
    public class ContentModule
    {
        ...
        public const string PROC_GET_CONTENT_MODULE_COURSE_PLAYER = "sproc_ContentModuleMaster_sel_CoursePlayer";
        ...
        public const string PROC_UPDATE_CONTENT_COURSE_DETAILS = "sproc_coursedetails_ups";
        public const string PROC_GET_SYSTEMUSERGUID_BYAT = "sproc_GetId_ByAuthenticationToken";

        public const string PROC_CHECK_CONTENT_PATH = "sproc_Check_Course_Path";
        public const string PROC_GET_LOCK_ASSESSMENTCOURSE = "sproc_ContentModuleMaster_selLockAssessmentCourse";
        //PARAMETERS

        public const string PARA_RAPIDEL_COURSE_ID = "@RapidelCourseId";
        public const string PARA_AUTHENTICATION_TOKEN = "@AuthenticationToken";
        ...
        public const string PARA_IS_MASTERCONTENT = "@IsMasterContent";
        public const string PARA_IS_ACTIVE = "@IsActive";
        ...
        public const string PARA_COURSE_ASSESSMENT_FLAG = "@CouseAssessmentFlag";
        public const string PARA_LOCK_ASSESSMENT = "@LockAssessment";
        public const string PARA_FIRST_FAILED_ATTEMPT_LOCKHRS = "@FirstFailedAttemptLockHrs";
        public const string PARA_ADMIN_UNLOCKHRS = "@AdminUnlockHrs";
        public const string PARA_SEND_EMAIL_TO_LEARNER = "@SendEmailToLearner";
        public const string PARA_SENDEMAIL = "@SendEmail";
        public const string PARA_SENDEMAILTOMANAGER = "@SendEmailToManager";
        public const string PARA_SENDEMAILTOMORE = "@SendEmailToMore";
        public const string PARA_SENDE_MAIL_TO_REGIONALADMIN = "@SendEmailToRegionalAdmin";
        public const string PARA_SENDEMAILTO = "@SendEmailTo";
        public const string PARA_SHOW_ASSESSMENT_RESULT = "@ShowAssessmentResult";
        public const string PARA_LOCK_ATTEMPT_ASSESSMENT = "@LockAttemptAssessment";
        public const string PARA_AFTER_NUMBER_OF_ATTEMPTS = "@AfterNumberofAttempts";
        public const string PARA_THUMBNAILIMGRELATIVEPATH = "@ThumbnailImgRelativePath";
        //FIELDS
        ...
        public const string COL_IS_MASTERCONTENT = "IsMasterContent";
        public const string COL_IS_ACTIVE = "IsActive";
        ...
        public const string COL_RAPIDEL_COURSEID = "RapidelCourseId";
        public const string COL_PERUSE_COURSEID = "PeruseCourseId";

        public const string COL_COURSE_ASSESSMENT_FLAG = "CouseAssessmentFlag";
        public const string COL_LOCK_ASSESSMENT = "LockAssessment";
        public const string COL_FIRST_FAILED_ATTEMPT_LOCKHRS = "FirstFailedAttemptLockHrs";
        public const string COL_ADMIN_UNLOCKHRS = "AdminUnlockHrs";
        public const string COL_SEND_EMAIL_TO_LEARNER = "SendEmailToLearner";
        public const string COL_SENDEMAIL = "SendEmail";
        public const string COL_SENDEMAILTOMANAGER = "SendEmailToManager";
        public const string COL_SENDEMAILTOMORE = "SendEmailToMore";
        public const string COL_SEND_EMAIL_TO_REGIONALADMIN = "SendEmailToRegionalAdmin";
        public const string COL_SENDEMAILTO = "SendEmailTo";
        public const string COL_SHOW_ASSESSMENT_RESULT = "ShowAssessmentResult";
        public const string COL_LOCK_ATTEMPT_ASSESSMENT = "LockAttemptAssessment";
        public const string COL_AFTER_NUMBER_OF_ATTEMPTS = "AfterNumberofAttempts";
        public const string COL_THUMBNAIL_IMG_PATH = "ThumbnailImgRelativePath";
    }
    #endregion
    ...
    public class ContentModuleTracking
    {
        ...
        public const string PROC_GET_CONTENT_MODULE_TRACKING = "sproc_UserContentModuleTracking_sel";
        ...
        public const string PROC_UPDATE_CONTENT_MODULE_TRACKING = "sproc_UserContentModuleTracking_ups";
        public const string PROC_UPDATE_ASSESSMENTCOURSE_TRACKING = "sproc_UserAssessmentCourseTracking_ups";
        public const string PROC_UPDATE_CONTENT_MODULE_TRACKING_Scorm2004 = "sproc_UserContentModuleTracking_ups_Scorm2004";
        public const string PROC_UPDATE_MARK_COMPLETED = "sproc_UserContentModuleTracking_ups_MarkCompleted";
        public const string PROC_USER_CONTENTMODULETRACKING_LSTALL = "sproc_UserContentModuleTracking_LstAll";
        public const string PROC_COURSEOBJECTIVETRACKING_USERSPECIFIC = "sproc_CourseObjectiveTracking_UserSpecific";
        public const string PROC_COURSEINTERACTIONTRACKING_USERSPECIFIC = "sproc_CourseInteractionTracking_UserSpecific";
        ...
        public const string PARA_CUSTOM_TOTAL_NO_OF_PAGES = "@CustomTotalNoOfPages";
        public const string PARA_CUSTOM_NO_OF_PAGES_COMPLETED = "@CustomNoOfPagesCompleted";
    ...
    public class Common
    {
        ...
        public const string PARA_CREATED_ON = "@DateCreated";
        ...
        public const string PARA_IS_ACTIVE = "@IsActive";
        public const string PARA_ADD_CONTACTPERSON = "@ContactPersonDetails";
        ...
        public const string PARA_BUSSINESS_RULE_ID = "@BusinessRuleId";
        ...
        public const string COL_CREATED_BY = "CreatedById";
        public const string COL_MODIFIED_ON = "LastModifiedDate";
        public const string COL_TOTALSESSIONDURATION = "TotalSessionDuration";
        public const string COL_MODIFIED_BY = "LastModifiedById";
        ...
        public const string VAL_UPDATE_MODE_MLIST = "ED_MList";
        ...
        public const int VAL_USER_ID_LENGTH = 12;
        // User
        public const string VAL_STUDENT_DETAIL_PREFIX = "UDTL";
        public const int VAL_STUDENT_DETAIL_LENGTH = 12;
        ...
        //Attempt Video Id
        public const string VAL_ATTEMPTVIDEO_ID_PREFIX = "AVM";
        public const int VAL_ATTEMPTVIDEO_ID_LENGTH = 12;
        //Organization Level
        ...
        //Product group
        public const string VAL_PRODUCTGROUP_ID_PREFIX = "GRP";
        public const int VAL_PRODUCTGROUP_ID_LENGTH = 8;

        //STORE Banner
        public const string VAL_STOREBANNER_ID_PREFIX = "BANN";
        public const int VAL_STOREBANNER_ID_LENGTH = 8;
        ...
        //For Certification Programs
        public const string VAL_CERTIFICATION_PROGRAM_ID_PREFIX = "CP";
        public const int VAL_CERTIFICATION_PROGRAM_ID_LENGTH = 8;
        ...
        //Assignments
        public const string VAL_Assignments_ID_PREFIX = "ASSN";
        public const int VAL_Assignments_ID_LENGTH = 8;

        //Assignments Topic
        public const string VAL_Assignmentstopic_ID_PREFIX = "ASNTPC";
        public const int VAL_AssignmentsTopic_ID_LENGTH = 8;

        //Assignment Attachments
        public const string VAL_AssignmentsAttachment_ID_PREFIX = "AATCH";
        public const int VAL_AssignmentsAttachment_ID_LENGTH = 8;

        //Assignments Note
        public const string VAL_AssignmentsNote_ID_PREFIX = "NT";
        public const int VAL_AssignmentsNote_ID_LENGTH = 8;
        ...
        // Course Question
        public const string VAL_COURSE_QUESTION_ID_PREFIX = "QUE";
        //OTP
        public const string VAL_OTP_PREFIX = "OTP";
        public const int VAL_OTP_LENGTH = 8;
        //Activity Certificate
        public const string VAL_ActivityCertificate_ID_PREFIX = "CER";
        public const int VAL_ActivityCertificate_ID_LENGTH = 8;
        public const string VAL_ActivityCertificate_Mapping_ID_PREFIX = "CERMap";

        //Chat
        public const string VAL_CHAT_ID_PREFIX = "CL";

        //LockUnlockCurriculumAssessment
        public const string VAL_LockUnlockCurriculumAssessment_ID_PREFIX = "LOCK";
        public const int VAL_LockUnlockCurriculumAssessment_ID_LENGTH = 8;

        //LockNumberOfAttemptsCourseAssessment
        public const string VAL_LockNumberOfAttemptsCourseAssessment_ID_PREFIX = "LOCKATT";
        public const int VAL_LockNumberOfAttemptsCourseAssessment_ID_LENGTH = 8;

        //Password Policy Number of email Requests
        public const string VAL_EMAIL_REQUEST_PREFIX = "ER";

        //Attempt Video Id
        public const string VAL_CONTENT_ASSESSMENT_INTERACTION_ID_PREFIX = "CAI";
        public const int VAL_CONTENT_ASSESSMENT_INTERACTIONO_ID_LENGTH = 12;

        //Attempt WebAPI Id
        public const string VAL_WebAPI_ID_PREFIX = "WEB";
        public const int VAL_WebAPI_ID_LENGTH = 12;
    ...
    public class AdminRoleFeatures
    {
        ...
        public const string PROC_GET_ALL_MENU_YPLS = "sproc_MenuYPLS_LstAll";
        //PARAMETERS
    ...
    //added by   
    #region RapidelUserService
    public class ClientServiceMaster
    {
        //PROCEDURES
        public const string PROC_GET_CLIENTSERVICEMASTER_DETAILS = "sproc_ClientServiceDetail_sel";
    ...
    #region publishing portal UserService
    public class PublishingPortalService
    {
        //PROCEDURES   
        public const string PROC_CHECK_ISHTTPS_ALLOWED = "sproc_CheckIsHttpsAllowed_sel";
        public const string PROC_CHECK_PUBLISHINGPORTAL_ACCESS = "sproc_CheckPublishingPortalAccess_sel";
        public const string PROC_VALIDATE_USER_LOGIN_KEY = "sproc_WS_ValidateUserLoginKey";
        public const string PROC_GENERATE_USER_LOGIN_KEY = "sproc_WS_GenerateUserLoginKey";
        public const string PROC_GET_PUB_PORTAL_USERS_SEL = "sproc_GetUsersForPPCreate_sel";
        public const string PROC_GET_PUB_PORTAL_USERS_DEACTIVATE = "sproc_GetUsersForPPDeActivate_sel";
        public const string PROC_UPDATE_USERAUTHENTICATION_TOKEN = "sproc_UserPPAuthenticationTokenInsert_ups";
        public const string PROC_GET_CLIENTDETAILS_SEL = "sp_getclientDetailsByClientId_sel";
        public const string PROC_UPDATE_PUBLISHINGPORTAL_PASSWORD = "sproc_UpdateUserPassword";
        public const string PROC_ACTIVIATE_DEACTIVATE_USER = "sproc_Activate_Deactivate_User";
        //PARAMETERS      

        public const string PARA_SystemUserGUID = "@LstSystemUserGuid";
        public const string PARA_ClientId = "@ClientId";
        public const string PARA_UserName = "@UserNameAlias";
        public const string PARA_Password = "@Password";
        public const string PARA_AuthenticationToken = "@AuthenticationToken";
        public const string PARA_EMAIL_ID = "@EmailID";
        public const string PARA_Unassign = "@UnAssign";
        public const string PARA_PublishingPoratlCustomFields = "@PublishingPortalCustomFields";

        public const string PARA_Loginkey = "@LoginKey";
        public const string PARA_ExpiryTime = "@ExpiryTime";
        public const string PARA_IsPublishingPortal = "@IsPublishingPortal";

        //FIELDS
        public const string COL_ID = "SystemUserGUID";
        public const string COL_USERNAME_ALIAS = "UserNameAlias";
        public const string COL_USER_PASSWORD = "UserPassword";
        public const string COL_FIRST_NAME = "FirstName";
        public const string COL_LAST_NAME = "LastName";
        public const string COL_EMAIL_ID = "EmailID";
        public const string COL_CLIENT_ID = "ClientId";
        public const string COL_CLIENT_NAME = "ClientName";
        public const string COL_CLIENT_ACCESS_URL = "ClientAccessURL";
        public const string COL_AUTHENTICATION_TOKEN = "PPAuthenticationToken";
        public const string COL_CUSTOMFIELDID_VALUE = "CustomfieldValue";
    ...
    {
        //PROCEDURES
        public const string PROC_GET_USERS_BY_ROLEID_SEL = "sproc_GetUserDetailsByRoleId_sel";
        public const string PROC_GET_USERS_BY_ROLEID_FORDEL_SEL = "sproc_GetUserDetailsByRoleId_Delete_sel";
        public const string PROC_GET_RAPIDEL_USERS_SEL = "sproc_RapidelUserDetails_sel";
        public const string PROC_GET_RAPIDEL_USERS_DEL = "sproc_RapidelUser_Delete_sel";
        public const string PROC_UPDATE_USERAUTHENTICATION_TOKEN = "sproc_UserAuthenticationTokenInsert_ups";
        public const string PROC_DELETE_USERAUTHENTICATION_TOKEN = "sproc_UserAuthenticationToken_ups";

        public const string PROC_VALIDATE_USER_LOGIN_KEY = "sproc_WS_ValidateUserLoginKey";
        public const string PROC_GENERATE_USER_LOGIN_KEY = "sproc_WS_GenerateUserLoginKey";

        public const string PROC_GET_SYSTEMUSERGUID_BYAT = "sproc_GetId_ByAuthenticationToken";
        public const string PROC_CHECK_RAPIDEL_ACCESS = "sproc_CheckRapidelAccess_sel";
        public const string PROC_UPDATE_RAPIDEL_PASSWORD = "sproc_UpdateUserPassword";
        public const string PROC_ACTIVIATE_DEACTIVATE_USER = "sproc_Activate_Deactivate_User";
        //PARAMETERS      
        ...
        public const string PARA_RoleId = "@RoleId";
        public const string PARA_EMAIL_ID = "@EmailID";
        public const string PARA_Loginkey = "@LoginKey";
        public const string PARA_ExpiryTime = "@ExpiryTime";
        public const string PARA_IsRapidel = "@IsRapidel";
        ...
        public const string COL_CLIENT_NAME = "ClientName";
        public const string COL_CLIENT_ACCESS_URL = "ClientAccessURL";
        public const string COL_AUTHENTICATION_TOKEN = "AuthenticationToken";
        public const string COL_EXPIRY_DATE = "ExpiryDate";
    }
    #endregion
    ...
    public class iPerformService
    {
        ...
        //PARAMETERS      
        public const string PARA_SystemUserGUID = "@PSystemUserGuid";
        public const string PARA_Loginkey = "@LoginKey";
        public const string PARA_ExpiryTime = "@ExpiryTime";
        public const string PARA_IsiPerform = "@IsiPerform";
    }
    ...
    #region PeruseUserService
    public class PeruseUserService
    {
        //PROCEDURES
        public const string PROC_GET_USERS_BY_ROLEID_SEL = "sproc_GetUserDetailsByRoleId_sel_Peruse";
        public const string PROC_GET_USERS_BY_ROLEID_FORDEL_SEL = "sproc_GetUserDetailsByRoleId_Delete_sel_Peruse";
        public const string PROC_GET_PERUSE_USERS_SEL = "sproc_PeruseUserDetails_sel";
        public const string PROC_GET_PERUSE_USERS_DEL = "sproc_PeruseUser_Delete_sel";
        public const string PROC_UPDATE_USERAUTHENTICATION_TOKEN = "sproc_PeruseUserAuthenticationTokenInsert_ups";
        public const string PROC_DELETE_USERAUTHENTICATION_TOKEN = "sproc_PeruseUserAuthenticationToken_ups";

        public const string PROC_VALIDATE_USER_LOGIN_KEY = "sproc_WS_ValidateUserLoginKey";
        public const string PROC_GENERATE_USER_LOGIN_KEY = "sproc_WS_GenerateUserLoginKey";

        public const string PROC_GET_SYSTEMUSERGUID_BYAT = "sproc_GetId_ByAuthenticationToken";
        public const string PROC_CHECK_PERUSE_ACCESS = "sproc_CheckPeruseAccess_sel";
        public const string PROC_UPDATE_PERUSE_PASSWORD = "sproc_UpdateUserPassword";
        public const string PROC_ACTIVIATE_DEACTIVATE_USER = "sproc_Activate_Deactivate_User";
        ...
        public const string PARA_Loginkey = "@LoginKey";
        public const string PARA_ExpiryTime = "@ExpiryTime";
        public const string PARA_IsPeruse = "@IsPeruse";
        public const string PARA_IsActive = "@IsActive";
        ...
        public const string COL_EXPIRY_DATE = "ExpiryDate";
        public const string COL_IsActive = "IsActive";
        public const string COL_IS_ADMIN = "UserTypeId";
    }
    #endregion
    ...
    public class JIRAUserService
    {
        ...
        public const string PARA_Loginkey = "@LoginKey";
        public const string PARA_ExpiryTime = "@ExpiryTime";
        public const string PARA_IsJIRAHelpDesk = "@IsJIRAHelpDesk";
    ...
    public class AdminRole
    {
        ...
        public const string PROC_GET_USERID_BY_ROLE_ID = "sproc_UserIdByRuleAssigned_sel";  //ADDED BY ..27/10/2015
        //PARAMETERS
        public const string PARA_ROLE_ID = "@RoleId";
        ...
        public const string COL_SYSTEM_USER_GUID = "SystemUserGUID"; //added by 
    ...
    internal class Lookup
    {
        ...
        public const string PARA_IS_DEFAULT = "@IsDefault";
        public const string PARA_IS_Curriculum = "@IsCurriculum";
    ...
    internal class ImportDefinition
    {
        ...
        public const string PROC_GET_PASSWORD_RESET_IMPORT_DEF = "sproc_ImportDefinitionMaster_CSVPasswordReset";
    ...
    #region ILTImportHistory
    internal class ILTImportHistory
    {
        //Procedure 
        public const string PROC_GET_IMPORT_HISTORY = "sproc_ILTImportHistory_sel";
        public const string PROC_GET_ALL_ILTIMPORT_HISTORY_SESSIONS = "sproc_ILTImportHistory_LstSessions";

        public const string PROC_UPDATE_IMPORT_HISTORY_DETAILS = "sproc_ILTImportHistory_ups_dtls";
        public const string PROC_DELETE_SELECTED_IMPORT_HISTORY = "sproc_ILTImportHistory_delMultiple";
        public const string PROC_UPDATE_ILTIMPORT_HISTORY = "sproc_ILTImportHistory_ups";
        public const string PROC_UPDATE_IMPORT_HISTORY_BULK_SESSION = "SPROC_ILTIMPORTHISTORY_UPS_BULKSESSION";

        //PARAMETERS
        public const string PARA_IMPORT_ID = "@ILTImportId";
        public const string PARA_EVENT_ID = "@ILTEventId";
        public const string PARA_FILE_NAME = "@ILTFileName";
        public const string PARA_FILE_PATH = "@ILTFilePath";
        public const string PARA_IMPORT_TYPE = "@ILTImportType";
        public const string PARA_IMPORT_ACTION = "@ILTImportAction";
        public const string PARA_IMPORT_LOG = "@ILTImportLog";
        public const string PARA_STATUS = "@Status";
        public const string PARA_IMPORT_BY_ID = "@ImportByID";
        public const string PARA_IMPORT_DATE_FROM = "@ImportDateFrom";
        public const string PARA_IMPORT_DATE_TO = "@ImportDateTo";
        ...
        //FIELDS
        public const string COL_IMPORT_ID = "ILTImportId";
        public const string COL_EVENT_ID = "ILTEventId";
        public const string COL_FILE_NAME = "ILTFileName";
        public const string COL_FILE_PATH = "ILTFilePath";
        public const string COL_IMPORT_TYPE = "ILTImportType";
        public const string COL_IMPORT_ACTION = "ILTImportAction";
        public const string COL_IMPORT_LOG = "ILTImportLog";
        public const string COL_IMPORT_DATE = "ILTImportDate";
        public const string COL_STATUS = "Status";
        public const string COL_IMPORT_BY_ID = "ImportByID";
        public const string COL_CLIENT_ID = "ClientID";
        public const string COL_ADMINISTRATOR_NAME = "AdministratorName";
    ...
    internal class MenuItems
    {
        ...
        public const string PROC_DOESGROUPADMIN_HAVEACCESS_TOMODULE = "sproc_DoesGroupAdminHaveAccessToModule";
        public const string PROC_GET_ALL_MENU_YPLS = "sproc_MenuYPLS_LstAll";
        public const string PROC_YPLS_ADMINHAVEACCESSTOMODULE = "sproc_YPLS_AdminHaveAccessToModule";
    ...
    #region Helpdesk
    internal class Helpdesk
    {
        //Procedure 
        public const string PROC_UPDATE_HELPDESK = "sproc_Helpdesk_ups";
        public const string PROC_UPDATE_HELPDESK_ATTACHMENT = "sproc_Helpdesk_Attachment_ups";
        public const string PROC_GET_HELPDESK = "sproc_HelpdeskList_sel";

        //PARAMETERS
        public const string PARA_HELPDESK_ID = "@HelpdeskId";
        public const string PARA_TITLE = "@Title";
        public const string PARA_EMAIL = "@Email";
        public const string PARA_ISSUE_TYPE = "@IssueType";
        public const string PARA_ACTIVITY_TYPE = "@ActivityType";
        public const string PARA_OPERATING_SYSTEM = "@OperatingSystem";
        public const string PARA_BROWSER = "@Browser";
        public const string PARA_DESCRIPTION = "@Description";
        public const string PARA_ACTIVITY_NAME = "@ActivityName";
        public const string PARA_IS_ACTIVE = "@IsActive";
        public const string PARA_IS_CLOSED = "@IsClosed";
        public const string PARA_STATUS = "@Status";
        public const string PARA_DATE_CREATED = "@DateCreated";
        public const string PARA_CREATED_BY_ID = "@CreatedById";
        public const string PARA_LAST_MODIFIED_DATE = "@LastModifiedDate";
        public const string PARA_LAST_MODIFIED_BY_ID = "@LastModifiedById";
        public const string PARA_RELATIVE_PATH = "@RelativePath";
        public const string PARA_ATTACHMENT_ID = "@AttachmentId";
        public const string PARA_ATTACHMENT_HELPDESK_ID = "@AttachmentHelpdeskId";

        //FIELDS
        public const string COL_HELPDESK_ID = "HelpdeskId";
        public const string COL_HELPDESK_TICKET_NO = "TicketNo";
    }
    #endregion
    ...
    internal class AssetLibrary
    {
        ...
        public const string PROC_GET_ASSET_LIBRARY_ForAssignment = "sproc_AssetLibraryMaster_sel_ForAssignment";
    ...
    public class Asset
    {
        ...
        public const string PROC_GET_ALL_ASSET_FORASSIGNMENTS = "sproc_AssetMaster_LstAll_FORASSIGNMENTS";
        ...
        public const string PROC_SEARCH_ASSET_RELATIVE_PATH = "sproc_Asset_RelativePath_sel";
        //PARAMETERS
        ...
        public const string PARA_RELATIVE_PATH = "@RelativePath";
        public const string PARA_IS_PRINT_CERTIFICATE = "@IsPrintCertificate";
        public const string PARA_IS_DOWNLOAD = "@IsDownload";
        public const string PARA_ASSET_FILENAME_LINK = "@AssetFileNameLink";
        public const string PARA_THUMBNAILIMGRELATIVEPATH = "@ThumbnailImgRelativePath";
        ...
        public const string COL_IS_DOWNLOAD = "IsDownload";
        public const string COL_ASSET_FILENAME_LINK = "AssetFileNameLink";
        public const string COL_THUMBNAIL_IMG_PATH = "ThumbnailImgRelativePath";
    ...
    internal class Policy
    {
        ...
        public const string PROC_GET_ALL_POLICY_ForAssignment = "sproc_PolicyMaster_LstAll_ForAssignment";
    ...
    internal class PolicyLibrary
    {
        ...
        public const string PROC_GET_POLICY_LIBRARY_FORAssignment = "sproc_PolicyLibraryMaster_sel_ForAssignment";
    ...
    internal class GroupRule
    {
        ...
        public const string PROC_GET_ALL_RULES_ForIPerform = "sproc_RuleMaster_LstAll_ForIPerform";
        ...
        public const string PROC_GETBUSINESSRULE_BYUSERID = "sproc_GetBusinessRule_ByUserId";
        //PARAMETERS
        public const string PARA_RULE_ID = "@RuleId";
    ...
    internal class BusinessRuleUsers
    {
        ...
        public const string PROC_GET_MULTI_BUSINESS_RULE_RESULT_USERS = "sproc_UserMaster_sel_MultipleRuleUsers";
    ...
    public class Curriculum
    {
        ...
        public const string PROC_GET_ALL_CURRICULUMS_ForEcatalog = "sproc_CurriculumMaster_LstAll_ForEcatalog";
        public const string PROC_GET_ALL_CURRICULUMS_ForDynamicAssignment = "sproc_CurriculumMaster_LstAll_ForDynamicAssignment";
        public const string PROC_GET_ALL_CURRICULUMS_FOREXISTINGACTIVITY = "sproc_CurriculumMaster_LstAll_ForExistingActivity";
        //PARAMETERS
    ...
    public class CurriculumActivity
    {
        ...
        public const string PROC_GET_CURRICULUM_ACTIVITY = "sproc_CurriculumActivity_sel_User";
        ...
        public const string COL_ACTIVITY_DESCRIPTION = "ActivityDescription";
    ...
    public class Questionnaire
    {
        ...
        //for Certification Survey
        public const string COL_IS_QUESTIONNAIRE_SURVEY = "IsQuestionnaireForSurvey";
        ...
        public const string PARA_IS_QUESTIONNAIRE_SURVEY = "@IsQuestionnaireForSurvey";
    }
    #endregion
    ...
    public class Assessment
    {
        ...
        public const string PROC_SHOW_ASSESSMENT_RESULT = "sproc_ShowAssessmentResult_sel";
        //FIELDS
        ...
        public const string COL_IS_INCORRECT_QUESTIONS = "IsIncorrectQuestions";
        public const string COL_SendEmailToAdminUser = "SendEmailToAdminUser";
        public const string COL_SendEmailTo = "SendEmailTo";
        public const string COL_AllowQueOptionRandamization = "AllowQueOptionRandamization";
        public const string COL_ISBOOK_MARKING = "IsBookMarking";
        ...
        public const string PARA_IS_INCORRECT_QUESTIONS = "@IsIncorrectQuestions";
        public const string PARA_SendEmailTo = "@SendEmailTo";
        public const string PARA_SendEmailToAdminUser = "@SendEmailToAdminUser";
        public const string PARA_AllowQueOptionRandamization = "@AllowQueOptionRandamization";
        public const string PARA_ISBOOK_MARKING = "@IsBookMarking";
    }
    #endregion
    ...
    public class UserAssessmentTracking
    {
        ...
        public const string COL_SUBMISSION_STATUS = "SubmissionStatus";
        public const string COL_Display_SUBMISSION_STATUS = "DisplaySubmissionStatus";
        public const string COL_START_DATE = "StartDate";
        public const string COL_COMPLETED_DATE = "CompletatedDate";
        public const string COL_ATTEMP_LANGUAGE_ID = "AttemptLanguageId";
        public const string COL_MARKED_COMPLETED_BY_ID = "MarkedCompletedById";
    ...
    public class Task
    {
        ...
        public const string PARA_NEXT_RUN_DATE = "@NextRunDate";
        //FIELDS
        ...
        public const string COL_NEXT_RUN_DATE = "NextRunDate";
    ...
    public class PasswordPolicyConfiguration
    {
        ...
        //Proc for EmailRequests
        public const string PROC_GET_EMAILREQUESTS_DETAILS= "sproc_GET_EmailRequestDetails";
        public const string PROC_ADDUPDATE_NO_OF_EMAILREQUESTS = "sproc_AddUpdateForgotPasswordEmailRequests";
        public const string PROC_ADDUPDATE_OTP_NO_OF_EMAILREQUESTS = "sproc_AddUpdateOTPEmailRequests";
        public const string PROC_CHECK_EMAIL_REQUEST_VALIDITY = "sproc_Check_OTP_Expire";
        ...
        public const string PARA_OTP_PWD_EXPIRY_HRS = "@OTPPasswordExpiryHrs";//Add Bharat: 16-Dec-2015
        public const string PARA_NO_OF_REQUESTS = "@NoOfRequests";// Samreen: 7th-oct-2021
        public const string PARA_REQUEST_VALIDITY_TIME = "@RequestValidityTime";// Samreen: 7th-oct-2021
        public const string PARA_NO_OF_OTP_EMAILREQUESTS = "@NoOfOtpEmailRequests";// Samreen: 10th May 2022
        public const string PARA_REQUEST_VALIDITY_TIME_FOR_OTP = "@RequestValidityTimeForOtp";// Samreen: 10th May 2022
                                                                                              //Parameters for EmailRequest Table
        public const string PARA_EMAIL_REQUEST_ID = "@EmailRequestID";
        public const string PARA_NO_OF_EMAIL_REQUESTS = "@NoOfEmailRequest";
        public const string PARA_REQUEST_VALIDITY_EXPIRY_TIME = "@ValidityExpiryTime";
        public const string PARA_SYSTEMUSERGUID = "@SystemUserGuid";
        ...
        public const string COL_OTP_PWD_EXPIRY_HRS = "OTPPasswordExpiryHrs";//Add Bharat: 16-Dec-2015
        public const string COL_NO_OF_REQUESTS = "NoOfRequests";//Samreen 7th Oct 2021
        public const string COL_REQUEST_VALIDITY_TIME = "RequestsValidityTime";//Samreen 7th Oct 2021  
        public const string COL_NO_OF_OTP_EMAILREQUESTS = "NoOfOtpEmailRequests";// Samreen: 10th May 2022
        public const string COL_REQUEST_VALIDITY_TIME_FOR_OTP = "RequestValidityTimeForOtp";// Samreen: 10th May 2022


         //Feilds for EmailRequest Table
        public const string COL_EMAIL_REQUEST_ID = "EmailRequestID";
        public const string COL_NO_OF_EMAIL_REQUESTS = "NoOfEmailRequest";
        public const string COL_REQUEST_VALIDITY_EXPIRY_TIME = "ValidityExpiryTime";
        public const string COL_SYSTEMUSERGUID = "SystemUserGuid";
    }
    #endregion
    ...
    public class UserPage
    {
        ...
        public const string PROC_GET_ALL_PAGE_ELEMENTS_LST_MUL = "sproc_UserPageElementLanguage_LstAllMul";
    ...
    public class Assignment
    {
        ...
        public const string PROC_GET_ASSIGNMENT_BY_ASSG_NAME = "sproc_MasterActivityAssignment_selByName";
    ...
    public class UserAssetTracking
    {
        ...
        public const string PROC_UPDATE_USER_ASSET_TRACKING_VIDEO = "sproc_UserAssetTracking_UpdateVideoTracking";
        public const string PROC_UPDATE_BOOKMARK_ASSET_VIDEO = "sproc_UpdateBookmarkAssetVideo";
        ...
        public const string PARA_REVIEWER_COMMENTS = "@ReviewerComments";
        public const string PARA_IS_FOR_ADMIN_PREVIEW = "@IsForAdminPreview";
        public const string PARA_WATCHEDINMINS = "@WatchedInMins";
        public const string PARA_PROGRESS = "@Progress";
        public const string PARA_VIDEO_EVENT = "@VideoEvent";
        public const string PARA_TOTAL_VIDEO_DURATION_IN_MINS = "@TotalVideoDurationInMins";
        public const string PARA_BOOKMARK_WATCHEDINMINS = "@BookmarkWatchedInMins";
        //FIELDS
        public const string COL_ASSET_ID = "AssetId";
        public const string COL_SYSTEM_USER_GUID = "SystemUserGUID";
        public const string COL_COMPLETION_STATUS = "CompletionStatus";
        ...
        public const string COL_REVIEWER_COMMENTS = "ReviewerComments";
        public const string COL_IS_FOR_ADMIN_PREVIEW = "IsForAdminPreview";
        public const string COL_WATCHEDINMINS = "WatchedInMins";
        public const string COL_PROGRESS = "Progress";
        public const string COL_VIDEO_EVENT = "VideoEvent";
        public const string COL_TOTAL_VIDEO_DURATION_IN_MINS = "TotalVideoDurationInMins";
        public const string COL_BOOKMARK_WATCHEDINMINS = "BookmarkWatchedInMins";
    }
    #endregion

    #region UserAssetVideoTracking
    public class UserAssetVideoTracking
    {
        //PROCEDURES
        public const string PROC_GET_USER_ASSET_TRACKING = "sproc_UserAssetVideoTracking_sel";
        public const string PROC_UPDATE_USER_ASSET_TRACKING = "sproc_UserAssetVideoTracking_ups";
        public const string PROC_UPDATE_USER_ASSET_TRACKING_VIDEO = "sproc_UserAssetVideoTracking_Update";
        public const string PROC_GET_USER_ASSET_TRACKING_ATTEMPT_COUNT = "sproc_UserAssetVideoTrackingAttemptwise_Count";

        //PARAMETERS
        public const string PARA_ATTEMPT_VIDEO_ID = "@AttemptVideoId";
        public const string PARA_ASSET_ID = "@AssetId";
        public const string PARA_SYSTEM_USER_GUID = "@SystemUserGUID";
        public const string PARA_DATE_OF_START = "@DateOfStart";
        public const string PARA_DATE_OF_COMPLETION = "@DateOfCompletion";
        public const string PARA_ACTIVITY_NAME = "@ActivityName";
        public const string PARA_WATCHEDINMINS = "@WatchedInMins";
        public const string PARA_TOTAL_VIDEO_DURATION_INMINS = "@TotalVideoDurationInMins";


        //FIELDS
        public const string COL_ATTEMPT_VIDEO_ID = "AttemptVideoId";
        public const string COL_ASSET_ID = "AssetId";
        public const string COL_SYSTEM_USER_GUID = "SystemUserGUID";
        public const string COL_DATE_OF_START = "DateOfStart";
        public const string COL_ACTIVITY_NAME = "ActivityName";
    ...
    public class LiveSession
    {
        ...
        public const string PROC_GET_LIVE_SESSION = "sproc_Get_LiveSession";
        ...
        public const string PARA_ClientIP = "@ClientIP";
        public const string PARA_SYSTEMUSERGUID = "@SystemUserGUID";
        //FIELDS
        ...
        public const string COL_ClientIP = "ClientIP";
        public const string COL_SYSTEMUSERGUID = "SystemUserGUID";
    }
    #endregion
    ...
    public class EmailDeliveryDashboard
    {
        ...
        public const string PROC_GET_EMAIL_DELIVERY_DASHBOARD_PENDING_APPROVAL = "sproc_EmailDeliveryDashboard_selPendingApproval";
    ...
    public class RuleRoleScope
    {
        ...
        public const string PARA_IsTCAAdminRights = "@IsTCAAdminRights";
        public const string PARA_IS_DEFAULT = "@IsDefault";
        ...
        public const string COL_IS_DEFAULT = "IsDefault";
        public const string COL_IS_TCAAdminRights = "IsTCAAdminRights";
    }
    #endregion
    ...
    #endregion
    #region SampleInstructions
    public class SampleInstruction
    {

        public const string PROC_GET = "sproc_SampleInstruction_sel";

        public const string COL_ID = "ID";
        public const string COL_MODULENAME = "ModuleName";
        public const string COL_SUBMODULENAME = "SubModuleName";
        public const string COL_PAGE = "Page";
        public const string COL_ImportOrTranslate = "IsImportOrTranslate";
        public const string COL_Purpose = "Purpose";
        public const string COL_SampleInstruction = "SampleInstruction";
        public const string PARA_LOGINKEY = "@ID";
    ...
    /****************** Added by Prajakta for Classroom Training ***************************************************************/
    ...
    public class ProgramMaster
    {
        ...
        public const string PROC_GET_ALL_PROGRAMMASTER_FORNOMINATION_ForCurriculum = "sproc_ProgramMaster_LstAll_ForNomination_ForCurriculum";
    ...
    public class SessionMaster
    {
        ...
        public const string PROC_GET_ALL_SESSIONMASTER_ProgramWise_DETAILS = "sproc_SessionMaster_sel_ProgramID_wise_Details";
    ...
    public class MerchantInfo
    {
        ...
        public const string PARA_ISACTIVE = "@IsActive";
        public const string PARA_PROTOCOL = "@Protocol";
        public const string PARA_PARTNERNAME = "@PartnerName";
        public const string PARA_VENDORNAME = "@VendorName";
        public const string PARA_USERNAME = "@UserName";
        public const string PARA_USERPASSWORD = "@UserPassword";
        ...
        public const string COL_ISACTIVE = "IsActive";
        public const string COL_PROTOCOL = "Protocol";
        public const string COL_PARTNERNAME = "PartnerName";
        public const string COL_VENDORNAME = "VendorName";
        public const string COL_USERNAME = "UserName";
        public const string COL_USERPASSWORD = "UserPassword";
    }
    #endregion
    ...
    public class Category
    {
        ...
        public const string PROC_GET_ALL_PRODUCTCATEGORY_LEARNER = "sproc_Category_ProductGroup_LstAll_Learner";
        ...
        public const string PROC_GET_PRODUCTCATEGORY_ISSHORTURLAVAILABLE = "sproc_ProductCategory_IsShortUrlAvailable";
        public const string PROC_GET_ALL_CERTIFIED_PROGRAM_CATEGORY = "sproc_GetCertifiedTrainingCategory_LstAll";
        ...
        public const string PARA_CATEGORYMETAKEYWORD = "@CategoryMetakeyword";
        public const string PARA_CATEGORYANALYTICCODE = "@CategoryAnalyticCode";
        public const string PARA_CATEGORYMETATITLE = "@CategoryMetaTitle";
        public const string PARA_CATEGORYMETADESCRIPTION = "@CategoryMetaDescription";
        public const string PARA_CATEGORYSHORTURL = "@ShortUrl";
        public const string PARA_THUMBNAILIMAGE = "@ThumbnailImage";
        public const string PARA_Flag = "@Flag";
        public const string PARA_LANGUAGE_ID = "@LanguageId";
        public const string PARA_IS_CERTIFIEDCATEGORY = "@isCertificationCategory";
        ...
        public const string COL_CATEGORYMETAKEYWORD = "CategoryMetakeyword";
        public const string COL_CATEGORYANALYTICCODE = "CategoryAnalyticCode";
        public const string COL_CATEGORYMETADESCRIPTION = "CategoryMetaDescription";
        public const string COL_CATEGORYMETATITLE = "CategoryMetaTitle";
        public const string COL_THUMBNAILIMAGE = "ThumbnailImage";
        public const string COL_CATEGORYSHORTURL = "ShortUrl";
        public const string COL_Flag = "Flag";
        public const string COL_IS_CERTIFIEDCATEGORY = "isCertificationCategory";
    }
    #endregion
    ...
    public class CategoryMapping
    {
        ...
        public const string PARA_ACTIVITY_NAME = "@ActivityName";
        public const string PARA_CATEGORY_NAME = "@CategoryName";
    ...
    public class Products
    {
        ...
        public const string PROC_Add_To_Cart = "sproc_Products_AddToCart";
        public const string PROC_List_Add_To_Cart_Item = "sproc_Products_ListAddCartItem";
        public const string PROC_List_DEL_DEACTIVATE_To_Cart_Item = "sproc_Products_ListAddCartItem_Del";
        public const string PROC_DELETE_CART_ITEM = "sproc_Cart_Item_del";
        ...
        public const string PROC_GET_PRODUCTS_REDIRECTION_CATALOG = "sproc_Products_Redirection_sel_Catalog";
        public const string PROC_GET_PRODUCTS_CATALOG_BYSHORTURL = "sproc_Products_sel_Catalog_ByShortUrl";
        public const string PROC_Add_GET_PRODUCTS_RECENTLY_VIEWED = "sproc_AddAndGet_products_RecentlyView_List";

        public const string PROC_Add_Get_RELATED_PRODUCTS = "sproc_Add_Get_RelatedProducts";
        public const string PROC_GET_PRODUCTS_IS_SHORTURL_AVAILABLE = "sproc_Products_IsShortUrlAvailable";
        ...
        public const string PARA_PRODUCTMETADESCRIPTION = "@ProductMetaDescription";
        public const string PARA_PRODUCTANALYTICCODE = "@ProductAnalyticCode";
        public const string PARA_PRODUCTMETATITLE = "@ProductMetaTitle";
        public const string PARA_PRODUCTMETAKEYWORD = "@ProductMetakeyword";
        public const string PARA_GROUPSHORTURL = "@GroupShortUrl";
        public const string PARA_CATEGORYSHORTURL = "@CategoryShortUrl";

        // public const string PARA_SYSTEMUSERGUID = "@Systemuserguid";
        public const string PARA_PRODID = "@ProductId";
        public const string PARA_PRODQUANTITY = "@Quantity";
        public const string PARA_SHORTURL = "@ShortUrl";
        public const string PARA_EXPIRYDATE = "@ExpiryDate";
        public const string PARA_EXPIRYMESSAGE = "@ExpiryMessage";
        public const string PARA_NOOFLICENSE = "@NoofLicense";
        public const string PARA_PRODUCTLICENSETYPE = "@ProductLicenseType";
        ...
        //Product redirection start
        public const string PARA_ISREDIRECTION = "@IsRedirection";
        public const string PARA_REDIRECTIONPRODID = "@RedirectionProdId";
        //Product redirection end
        public const string PARA_PUBLISHDATE = "@PublishDate";
        public const string PARA_BASEPRICE = "@BasePrice";
        public const string PARA_DISCOUNTEDPRICE = "@DiscountedPrice";
        ...
        public const string PARA_SYSTEMUSERGUID = "@SystemUserGUID";
        public const string PARA_TYPEOFReq = "@TypeOfReq";
        public const string PARA_TAXCODE = "TaxCode";
        public const string PARA_RELATEDPRODUCTLST = "@RelatedProductLst";
        //FIELDS
        ...
        //ADDED BY CHETAN
        public const string COL_PRODUCTMETAKEYWORD = "ProductMetakeyword";
        public const string COL_TAXCODE = "TaxCode";
        public const string COL_PRODUCTANALYTICCODE = "ProductAnalyticCode";
        public const string COL_PRODUCTMETADESCRIPTION = "ProductMetaDescription";
        public const string COL_PRODUCTMETATITLE = "ProductMetaTitle";
        public const string COL_SYSTEMUSERGUID = "Systemuserguid";
        public const string COL_PARAPRODID = "ProductId";
        public const string COL_PARAPRODQUANTITY = "Quantity";
        public const string COL_CARTID = "CartId";

        public const string COL_NOOFLICENSE = "NoofLicense";
        public const string COL_PRODUCTLICENSETYPE = "ProductLicenseType";
        //
        public const string COL_CATEGORYNAME = "CategoryName";
        public const string COL_CATEGORYID = "CategoryId";
        ...
        public const string COL_ACTIVITYTYPEIDENG = "ActivityTypeIdEng";
        public const string COL_ISACTIVE = "IsActive";
        ...
        public const string COL_DISCOUNTEDPRICE = "DiscountedPrice";
        ...
        public const string COL_SHORTURL = "ShortUrl";
        public const string COL_EXPIRYDATE = "ExpiryDate";
        public const string COL_EXPIRYDATEN = "ExpiryDateN";
        public const string COL_EXPIRYMESSAGE = "ExpiryMessage";
        public const string COL_ISREDIRECTION = "IsRedirection";
        public const string COL_REDIRECTIONPRODID = "RedirectionProdId";
        //Added by Atul
        public const string COL_ACTIVITYEXPIRYDATE = "ActivityExpiryDate";
    }
    #endregion
    ...
    public class ProductsLanguage
    {
        ...
        public const string PARA_PRODUCTMETATITLE = "@ProductMetaTitle";
        public const string PARA_TAXCODE = "TaxCode";
        public const string PARA_CARTID = "@CartId";
    ...
    public class ProductGroup
    {
        ...
        public const string PROC_DELETE_PRODUCTGROUP = "sproc_ProductGroup_del";
        public const string PROC_GET_GROUPS_BY_PRODUCTCODE = "sproc_ProductsGroups_sel_By_GroupCode";
        public const string PROC_GET_GROUPS_BY_PRODUCTGROUPNAME = "sproc_ProductsGroups_sel_By_GroupName";
        public const string PROC_UPDATE_PRODUCTGROUP = "sproc_AddupdateProductGroup_ups";
        public const string PROC_GET_ALL_PRODUCTGROUP = "sproc_ProductGroup_LstAll";
        public const string PROC_GET_PRODUCTGROUP = "sproc_ProductGroup_Sel";
        public const string PROC_ACTIVE_PRODUCTGROUP = "sproc_ProductGroup_ups_IsActive";
        public const string PROC_UPDATE_PRODUCTGROUP_STATUS = "sproc_ManageProductGroups_ups_Status";
        public const string PROC_Add_Get_RELATED_PRODUCTGROUPS = "sproc_Add_Get_Mapped_GroupProducts";
        public const string PROC_GET_ALL_PRODUCTGROUP_LEARNER = "sproc_ProductGroup_LstAll_Learner";
        public const string PROC_GET_ALL_PRODUCTGROUP_CATEGORY_LEARNER = "sproc_ProductGroup_Category_LstAll_Learner";
        public const string PROC_GET_GROUPS_BY_SHORTURL = "sproc_ProductsGroups_sel_By_ShortURL";
        public const string PROC_UPDATE_GROUPS_SEQUENCE = "sproc_ProductGroup_Sequence_ups";

        //PARAMETERS
        public const string PARA_GROUPID = "@GroupId";
        public const string PARA_GROUPCODE = "@GroupCode";
        public const string PARA_GROUPNAME = "@GroupName";
        public const string PARA_NAME = "@Name";
        public const string PARA_GROUPDESCRIPTION = "@GroupDescription";

        public const string PARA_GROUPMETAKEYWORD = "@GroupMetakeyword";
        public const string PARA_GROUPMETADESCRIPTION = "@GroupMetaDescription";
        public const string PARA_GROUPANALYTICCODE = "@GroupAnalyticCode";
        public const string PARA_GROUPMETATITLE = "@GroupMetaTitle";
        public const string PARA_SHORTURL = "@ShortUrl";
        public const string PARA_Flag = "@Flag";
        public const string PARA_CREATEDBYID = "@CreatedById";
        public const string PARA_MAPPEDPRODUCTLST = "@MappedProductLst";
        public const string PARA_TYPEOFReq = "@TypeOfReq";
        ...
        public const string PARA_SYSTEMUSERGUID = "@SystemUserGUID";
        //FIELDS
        public const string COL_GROUPID = "GroupId";
        public const string COL_GROUPCODE = "GroupCode";
        public const string COL_GROUPNAME = "GroupName";
        public const string COL_NAME = "Name";
        public const string COL_GROUPDESCRIPTION = "GroupDescription";


        public const string COL_GROUPMETAKEYWORD = "GroupMetakeyword";
        public const string COL_GROUPANALYTICCODE = "GroupAnalyticCode";
        public const string COL_GROUPMETADESCRIPTION = "GroupMetaDescription";
        public const string COL_GROUPMETATITLE = "GroupMetaTitle";
        public const string COL_SYSTEMUSERGUID = "Systemuserguid";
    ...
    #region ProductGroupLanguage
    public class ProductGroupLanguage
    {
        //PROCEDURES
        public const string PROC_UPDATE_PRODUCTGROUP_LANGUAGE = "sproc_ProductGroupLanguage_ups";
    ...
    public class Calendar
    {
        ...
        public const string PROC_GET_CALENDAR_EVENTS_ADMIN = "sproc_Calendar_Events_Admin";
        //PARAMETERS
        public const string PARA_START_DATE = "@startDate";
        public const string PARA_END_DATE = "@endDate";
        public const string PARA_Activity_ID = "@activityID";
        ...
        public const string COL_SYSTEMUSER_GUID = "SystemUserGUID";
        public const string COL_USERNAME_ALIAS = "Usernamealias";
    ...
    public class OrderHistory
    {
        ...
        public const string PARA_FirstName = "@ToFirstName";
        public const string PARA_LastName = "@ToLastName";
        public const string PARA_Address1 = "@ToAddress1";
        public const string PARA_City = "@ToCity";
        public const string PARA_State = "@ToState";
        public const string PARA_ZipCode = "@ToZipCode";
        public const string PARA_Country = "@ToCountry";
        public const string PARA_TaxRate = "@TaxRate";
        public const string PARA_TaxAmount = "@TaxAmount";
        public const string PARA_Address2 = "@ToAddress2";
        public const string PARA_PhoneNo = "@ToPhoneNo";
        public const string PARA_AVATAXID = "@AvaTaxId";
        ...
        public const string COL_DiscountAmount = "DiscountTotal";
        ...
        public const string COL_FirstName = "ToFirstName";
        public const string COL_LastName = "ToLastName";
        public const string COL_Address1 = "ToAddress1";
        public const string COL_City = "ToCity";
        public const string COL_State = "ToState";
        public const string COL_ZipCode = "ToZipCode";
        public const string COL_Country = "ToCountry";
        public const string COL_TaxRate = "TaxRate";
        public const string COL_TaxAmount = "TaxAmount";
        public const string COL_Address2 = "ToAddress2";
        public const string COL_PhoneNo = "ToPhoneNo";
        public const string COL_AvaTaxId = "AvaTaxId";
        public const string COL_USERORDERCOUNT = "UserOrderCount";
        public const string VAL_ORDER_ID_PREFIX = "POH";
        public const string VAL_AVATAX_ID_PREFIX = "ATX";
    }
    #endregion
    ...
    public class DiscountCoupon
    {
        ...
        public const string PROC_GET_DiscountCoupon_Coupon_Code = "sproc_Products_sel_Catalog_ByShortUrl";
        ...
        public const string PARA_COUPON_APPLIED_TO = "@AppliedTo";
        public const string PARA_PROD_CAT_ID = "@ProdCatId";
        public const string PARA_COUPON_TYPE = "@CouponType";
        public const string PARA_NO_OF_USERS = "@NoOfUser";
        public const string PARA_START_DATE = "@Startdate";
        public const string PARA_END_DATE = "@Enddate";
        public const string PRAR_COUPON_USED_COUNT = "@UsedCount";
        ...
        public const string COL_COUPON_APPLIED_TO = "AppliedTo";

        public const string COL_COUPON_TYPE = "CouponType";
        public const string COL_NO_OF_USERS = "NoOfUser";
        public const string COL_START_DATE = "StartDate";
        public const string COL_PROD_CAT_ID = "ProdCatId";
        public const string COL_COUPON_USED_COUNT = "UsedCount";
    }
    #endregion
    ...
    public class FeatureList
    {
        ...
        public const string COL_ISACTIVE = "IsActive";
        public const string COL_FEATUREVALUE = "Value";
    }
    #endregion
    #region Browser
    public class Browser
    {
        ...
        public const string PARA_MAXMAJORVERSION = "@MaxMajorVersion";
        //FIELDS
        ...
        public const string COL_MAXMAJORVERSION = "MaxMajorVersion";
    }
    #endregion
    ...
    public class ParticipantDetails
    {
        ...
        public const string VENDOR_COMPANY_PREFIX = "CMP";
    ...
    //******************added by deepak dangat for curriculam section************************************************
    ...
    public class OrderDetails
    {
        ...
        public const string PARA_DISCOUNT = "@Discount";
        public const string PARA_TOTAL_PRICE = "@TotalPrice";
        public const string PARA_NOOFLICENSE = "@NoofLicense";
        ...
        public const string COL_TOTAL_PRICE = "TotalPrice";
        public const string COL_NOOFLICENSE = "NoofLicense";
    }
    #endregion
    ...
    public class ProductCatalogSettings
    {
        ...
        public const string PARA_IS_ACTIVE = "@IsActive";
        public const string PARA_TYPE = "@Type";
    ...
    public class VirtualTrainingSessionMaster
    {
        ...
        public const string PROC_VIRTUALTRAINING_SESSIONMASTER_UPDATE = "sproc_VirtualTrainingSessionMaster_ups";
        public const string PROC_VIRTUALTRAINING_GETALL_ForCurriculum = "sproc_VirtualTrainingSessionMaster_LstAll_ForCurriculum";
        //PARAMETER
    ...
    public class VirtualTrainingAttendeeMaster
    {
        ...
        public const string PROC_VIRTUALTRAINING_AddFailureAttendeeList = "sproc_VirtualTrainingAddFailureAttendeeList";
        ...
        public const string COL_VIRTUALTRAINING_CreatedByName = "CreatedByName";
        //// Prefix
    ...
    public class VirtualTrainingUserMaster
    {
        ...
        public const string PARA_VIRTUALTRAINING_WEBEX_URL = "@WexExURL";
        public const string PARA_ZOOMACCESSTOKEN = "@ZoomAccessToken";
        //User master
        ...
        public const string COL_VIRTUALTRAINING_WEBEX_URL = "WexExURL";
        public const string COL_ZOOMACCESSTOKEN = "ZoomAccessToken";
        //Prefix
    ...
    /************************************** added by Prajakta for Assignments *********************************************/

    #region Assignments
    public class Assignments
    {
        //Procedure
        public const string PROC_UPDATE_ASSIGNMENTS = "sproc_AssignmentMaster_ups";
        public const string PROC_DELETE_ASSIGNMENTS = "sproc_AssignmentMaster_del";
        public const string PROC_GET_ASSIGNMENTS = "sproc_AssignmentMaster_sel";
        public const string PROC_GET_ALL_ASSIGNMENTS = "sproc_AssignmentMaster_LstAll";
        public const string PROC_UPDATE_ASSIGNMENTS_LANGUAGE = "sproc_AssignmentsMaster_ups_Language";
        public const string PROC_GET_ASSIGNMENTS_LANGUAGES = "sproc_AssignmentsLanguage_sel_List";
        public const string PROC_DELETE_ASSIGNMENTS_LANGUAGE = "sproc_AssignmentsLanguage_del";


        //PARAMETERS
        public const string PARA_ASSIGNMENT_ID = "@AssignmentId";
        public const string PARA_ASSIGNMENT_TITLE = "@AssignmentTitle";
        public const string PARA_OBJECTIVE = "@objective";
        public const string PARA_PONTS = "@Points";
        public const string PARA_CATEGORY = "@CategoryID";
        public const string PARA_SUBCATEGORY = "@SubCategoryID";
        public const string PARA_ATTACHMENTS = "@Attachments";
        public const string PARA_IS_SUBMISSIONAPPROVAL = "@IsSubmissionAprroval";
        public const string PARA_IS_PRINT = "@IsPrint";
        public const string PARA_IS_SAVE_PARTIAL_ASSIGNMENT = "@IsSavePartialAssignment";
        public const string PARA_IS_ACTIVE = "@IsActive";
        ...
        public const string COL_OBJECTIVE = "objective";
        public const string COL_PONTS = "Points";
        public const string COL_CATEGORY = "Category";
        public const string COL_SUBCATEGORY = "SubCategory";
        public const string COL_ATTACHMENTS = "Attachments";
        public const string COL_IS_SUBMISSIONAPPROVAL = "IsSubmissionApproval";
        public const string COL_IS_PRINT = "IsPrint";
        public const string COL_IS_SAVE_PARTIAL_ASSIGNMENT = "IsSavePartialAssignment";
        public const string COL_CATEGORY_NAME = "CategoryName";
        public const string COL_SUBCATEGORY_NAME = "SubCategoryName";
        public const string COL_IS_ACTIVE = "IsActive";
    }
    ...
    #region AssignmentsTopics
    public class AssignmentTopic
    {
        //Procedure
        public const string PROC_UPDATE_TOPICS = "sproc_AssignmentTopictMaster_ups";
        public const string PROC_DELETE_TOPICS = "sproc_AssignmentTopicMaster_del";
        public const string PROC_GET_TOPICS = "sproc_AssignmentTopicMaster_sel";
        public const string PROC_GET_ALL_TOPICS = "sproc_AssignmentTopicMaster_LstAll";
        public const string PROC_UPDATE_TOPICS_LANGUAGE = "sproc_AssignmentTopicLanguage_ups";
        public const string PROC_GET_TOPICS_LANGUAGES = "sproc_AssignmentTopicLanguage_sel_List";
        public const string PROC_DELETE_TOPICS_LANGUAGE = "sproc_AssignmentTopicLanguage_del";


        //PARAMETERS
        public const string PARA_TOPIC_ID = "@TopicId";
        public const string PARA_ASSIGNMENT_ID = "@AssignmentId";
        public const string PARA_TOPIC_TITLE = "@TopicTitle";
        public const string PARA_TOPIC_DESCRIPTION = "@TopicDescription";
        public const string PARA_IS_MANDATORY_FOR_COMPLETION = "@IsMandatoryForCompletion";
        public const string PARA_IS_ACTIVE = "@IsActive";

        //FIELDS
        public const string COL_TOPIC_ID = "TopicId";
        public const string COL_ASSIGNMENT_ID = "AssignmentId";
        public const string COL_TOPIC_TITLE = "TopicTitle";
        public const string COL_TOPIC_DESCRIPTION = "TopicDescription";
        public const string COL_IS_MANDATORY_FOR_COMPLETION = "IsMandatoryForComletion";
        public const string COL_IS_ACTIVE = "IsActive";
        public const string VAL_Assignmentstopic_ID_PREFIX = "ASNTPC";
    }
    #endregion

    #region AssignmentAttachments
    public class AssignmentAttachments
    {
        //Procedure
        public const string PROC_UPDATE_ATTACHMENTS = "sproc_AssignmentAttachmentMaster_ups";
        public const string PROC_DELETE_ATTACHMENTS = "sproc_AssignmentAttachmentMaster_del";
        public const string PROC_GET_ALL_ATTACHMENTS = "sproc_AssignmentAttachmentMaster_LstAll";
        public const string PROC_GET_ATTACHMENTS = "sproc_AssignmentAttachmentMaster_sel";
        public const string PROC_UPDATE_ATTACHMENTS_LANGUAGE = "sproc_AssignmentAttachmentLanguage_ups";
        public const string PROC_GET_ATTACHMENTS_LANGUAGES = "sproc_AssignmentAttachmentLanguage_sel_List";
        public const string PROC_DELETE_ATTACHMENTS_LANGUAGE = "sproc_AssignmentAttachmentLanguage_del";


        //PARAMETERS
        public const string PARA_ATTACHMENT_ID = "@AttachmentId";
        public const string PARA_ASSIGNMENT_ID = "@AssignmentId";
        public const string PARA_ATTACHMENT_NAME = "@AttachmentName";


        //FIELDS
        public const string COL_ATTACHMENT_ID = "AttachmentId";
        public const string COL_ASSIGNMENT_ID = "AssignmentId";
        public const string COL_ATTACHMENT_NAME = "AttachmentName";
        public const string VAL_ATTACHMENT_ID_PREFIX = "AATCH";
    }
    #endregion

    #region AssignmentNotes
    public class AssignmentNotes
    {
        //Procedure
        public const string PROC_UPDATE_NOTES = "sproc_AssignmentNoteMaster_ups";
        public const string PROC_DELETE_NOTES = "sproc_AssignmentNoteMaster_del";
        public const string PROC_GET_NOTES = "sproc_AssignmentNoteMaster_sel";
        public const string PROC_GET_ALL_NOTES = "sproc_AssignmentNoteMaster_LstAll";
        public const string PROC_UPDATE_NOTES_LANGUAGE = "sproc_AssignmentNoteLanguage_ups";
        public const string PROC_GET_NOTES_LANGUAGES = "sproc_AssignmentNoteLanguage_sel_List";
        public const string PROC_DELETE_NOTES_LANGUAGE = "sproc_AssignmentNoteLanguage_del";


        //PARAMETERS
        public const string PARA_NOTE_ID = "@AssignmentNoteId";
        public const string PARA_ASSIGNMENT_ID = "@AssignmentId";
        public const string PARA_NOTE = "@Note";
        public const string PARA_ATTACHMENT_NAME = "@AttachmentName";
        public const string PARA_IS_ACTIVE = "@IsActive";

        //FIELDS
        public const string COL_NOTE_ID = "AssignmentNoteId";
        public const string COL_ASSIGNMENT_ID = "AssignmentId";
    ...
    {
        //Procedure 
        public const string PROC_UPDATE_AUDITTRAIL = "sproc_AuditTrail_ups";
        public const string PROC_GET_ALL_AUDITTRAIL = "sproc_AuditTrail_LstAll";
        public const string PROC_GET_ALL_AUDITTRAIL_ARCHIVE = "sproc_AuditTrailArchive_LstAll";

        //PARAMETERS            
        public const string PARA_ENTITYNAME = "@EntityName";
        public const string PARA_SYSTEM_USER_GUID = "@SystemUserGUID";
        public const string PARA_RECORDID = "@RecordID";
        public const string PARA_ACTIONID = "@ActionID";
        public const string PARA_OLDDATA = "@OldData";
        public const string PARA_NEWDATA = "@NewData";
        public const string PARA_USERNAME = "@UserName";
        public const string PARA_FROMDATE = "@FromDate";
        public const string PARA_TODATE = "@ToDate";
        ...
        public const string COL_AUDITTRAILID = "AuditTrailId";
        public const string COL_SYSTEMUSERGUID = "SystemUserGUID";
        public const string COL_USERNAME = "UserName";
        public const string COL_AUDITTRAILDATE = "AuditTrailDate";
        public const string COL_ACTIONID = "ActionId";
        public const string COL_RECORDID = "RecordID";
        public const string COL_DESCRIPTION = "Description";
        public const string COL_OLDDATA = "OldData";
        public const string COL_NEWDATA = "NewData";
        public const string COL_USERNAMEALIAS = "UserNameAlias";

        public const string COL_ARCHIVEID = "ArchiveId";
        public const string COL_ARCHIVEBYID = "ArchiveById";
        public const string COL_ARCHIVEBY = "ArchiveBy";
        public const string COL_ARCHIVEDATE = "ArchiveDate";
        public const string COL_ARCHIVEFROMDATE = "ArchiveFrom";
        public const string COL_ARCHIVETODATE = "ArchiveTo";
        public const string COL_ARCHIVEXMLPATH = "ArchiveXMLPath";
    ...
    {
        //PROCEDURES
        public const string PROC_COURSEQUESTIONS_UPS = "sproc_CourseQuestions_ups";
        public const string PROC_COURSEQUESTIONS_DEL = "sproc_CourseQuestions_del";

        //PARAMETERS
        public const string PARA_QUESTION_GUID = "@QuestionGUID";
        public const string PARA_COURSEID = "@CourseId";
        public const string PARA_QUESTION_ID = "@QuestionId";
        public const string PARA_QUESTION_TEXT = "@QuestionText";
        public const string PARA_QUESTION_TYPE = "@QuestionType";
        public const string PARA_CORRECT_ANSWER = "@CorrectAnswer";
        public const string PARA_QUESTION_OPTION_STRING = "@QuestionOptionString";
        public const string PARA_OBJECTIVE_ID = "@ObjectiveId";

        //FIELDS
        public const string COL_QUESTION_GUID = "QuestionGUID";
        public const string COL_COURSEID = "CourseId";
        public const string COL_QUESTION_ID = "QuestionId";
        public const string COL_QUESTION_TEXT = "QuestionText";
        public const string COL_QUESTION_TYPE = "QuestionType";
        public const string COL_CORRECT_ANSWER = "CorrectAnswer";
        public const string COL_QUESTION_OPTION_STRING = "QuestionOptionString";
        public const string COL_OBJECTIVE_ID = "ObjectiveId";
    ...
    {
        //Procedure 
        public const string PROC_UPDATE_CHAT = "sproc_ChatLog_ups";
        public const string PROC_GET_ALL_CHAT = "sproc_ChatLog_LstAll";
        public const string PROC_DELETE_CHAT = "sproc_ChatLog_del";


        //PARAMETERS            
        public const string PARA_FROMUSERID = "@FromUserId";
        public const string PARA_TOUSERID = "@ToUserId";
        public const string PARA_CHATID = "@ChatId";
        public const string PARA_FILENAME = "@FileName";
        public const string PARA_TYPE = "@Type";
        public const string PARA_FROMDATE = "@FromDate";
        public const string PARA_TODATE = "@ToDate";
        public const string PARA_SEARCHTEXT = "@SearchText";

        //FIELDS
        public const string COL_FROMUSERID = "FromUserId";
        public const string COL_TOUSERID = "ToUserId";
        ...
        public const string COL_FROMUSERNAMEALIAS = "FromUserNameAlias";
        public const string COL_TOUSERNAMEALIAS = "ToUserNameAlias";
    }
    #endregion


    #region ActivityCertificate
    public class ActivityCertificate
    {
        //PROCEDURES

        public const string PROC_ACTIVITYCERTIFICATE_LSTALL = "sproc_ActivityCertificate_LstAll";
        public const string PROC_ACTIVITYCERTIFICATE_DEL = "sproc_ActivityCertificate_del";
        public const string PROC_ACTIVITYCERTIFICATE_ActivateDeactivate = "sproc_ActivityCertificate_ActivateDeactivate";
        public const string PROC_ACTIVITYCERTIFICATE_UPS = "sproc_ActivityCertificate_ups";
        public const string PROC_GET_ACTIVITYCERTIFICATE_DATA = "sproc_GetActivityCertificateData";
        public const string PROC_GET_ACTIVITYCERTIFICATE_DATA_BYACTiVITYID = "sproc_GetActivityCertificateData_ByActivityId";
        public const string PROC_ACTIVITYCERTIFICATEMAPPING_DEL = "sproc_ActivityCertificateMapping_del";
        public const string PROC_ACTIVITYCERTIFICATE_LANG_LSTALL = "sproc_ActivityCertificate_Lang_LstAll";
        public const string PROC_ACTIVITYCERTIFICATE_Trans_UPS = "sproc_ActivityCertificate_Trans_ups";

        //PARAMETERS
        public const string PARA_ACTIVITYCERTIFICATEID = "@CertificateID";
        public const string PARA_ACTIVITYID = "@ActivityID";
        public const string PARA_LANGUAGEID = "@LanguageID";
        public const string PARA_TITLE = "@Title";
        public const string PARA_ISACTIVE = "@IsActive";
        public const string PARA_BackGroundImage = "@BackGroundImages";
        public const string PARA_IsDefault = "@IsDefault";
        public const string PARA_BODY_MESSAGE = "@BodyMessage";
        public const string PARA_DESCRIOTION = "@Description";
        public const string PARA_CreatedById = "@CreatedById";
        public const string PARA_CerImageData = "@XmlData";
        public const string PARA_UpdateMode = "@UpdateMode";

        //FIELDS
        public const string COL_CertificateId = "CertificateId";
        public const string COL_LANGUAGEID = "LanguageID";
        public const string COL_CertificateName = "CertificateName";
        public const string COL_CertificateDescription = "CertificateDescription";
        public const string COL_BodyMessage = "BodyMessage";
        public const string COL_IsDefault = "IsDefault";
        public const string COL_IsActive = "IsActive";
        public const string COL_BackGroundImage = "BackGroundImage";
        public const string COL_ActionURL = "ActionURL";
    }
    #endregion

    #region ActivityCertificateMapping
    public class ActivityCertificateMapping
    {
        //PROCEDURES
        public const string PROC_Activity_CertificateMapping_del = "sproc_ActivityCertificateMapping_del";
        public const string PROC_Activity_Certificate_Mapping_UPS = "sproc_ActivityCertificateMapping_ups";
        public const string PROC_ACTIVITYCERTIFICATEMAPPING_LSTALL = "sproc_ActivityCertificateMapping_LstAll";
        public const string PROC_GET_CATEGORY_MAPPING = "sproc_CategoryActivityMapping_Sel";
        public const string PROC_GET_ALL_CATEGORY_MAPPING_BY_CATEGORY = "sproc_CategoryActivityMapping_LstAll_ByCategory";

        //PARAMETERS
        public const string PARA_ACTIVITY_ID = "@ActivityId";
        public const string PARA_ACTIVITY_TYPE_ID = "@ActivityType";
        public const string PARA_Certificate_ID = "@CertificateId";
        public const string PARA_MAPPING_ID = "@MappingId";
        public const string PARA_Activity_Name = "@ActivityName";
        public const string PARA_Certificate_NAME = "@CertificateName";

        //FIELDS
        public const string COL_ACTIVITY_ID = "ActivityId";
        public const string COL_ACTIVITY_TYPE_ID = "ActivityType";
        public const string COL_CERTIFICATE_ID = "CertificateId";
        public const string COL_MAPPING_ID = "MappingId";
        public const string COL_ACTIVITY_NAME = "ActivityName";
        public const string COL_CERTIFICATE_NAME = "CertificateName";
    }
    #endregion
    ...
    {
        //PROCEDURES
        public const string PROC_DELETE_PRODUCTLANDINGPAGEBANNER = "sproc_ProductLandingPageBanner_del";
        public const string PROC_UPDATE_PRODUCTLANDINGPAGEBANNER = "sproc_ProductLandingPageBanner_ups";
        public const string PROC_GET_ALL_PRODUCTLANDINGPAGEBANNER = "sproc_ProductLandingPageBanner_LstAll";
        public const string PROC_GET_PRODUCTLANDINGPAGEBANNER = "sproc_ProductLandingPageBanner_Sel";
        public const string PROC_UPDATE_BANNER_SEQUENCE = "sproc_Banner_Sequence_ups";

        //PARAMETERS
        public const string PARA_BANNERID = "@BannerId";
        public const string PARA_BANNERALTTEXT = "@BannerAltText";
        public const string PARA_BANNERNAME = "@BannerName";
        public const string PARA_SEQUENCE = "@Sequence";
        public const string PARA_PRODUCTID = "@ProductId";
        public const string PARA_ShortURL = "@ShortURL";
        ...
        public const string COL_BANNERALTTEXT = "BannerAltText";
        public const string COL_ShortURL = "ShortURL";
        public const string COL_BANNERNAME = "BannerName";
        public const string COL_SEQUENCE = "Sequence";
        public const string COL_PRODUCTID = "ProductId";
    }
    ...
    {
        //PROCEDURES
        public const string PROC_DELETE_PRODUCTLANDINGPAGEBANNERLANGUAGE = "sproc_ProductLandingPageBannerLanguage_del";
        public const string PROC_UPDATE_PRODUCTLANDINGPAGEBANNERLANGUAGE = "sproc_ProductLandingPageBannerLanguage_ups";
        public const string PROC_GET_ALL_PRODUCTLANDINGPAGEBANNERLANGUAGE = "sproc_ProductLandingPageBannerLanguage_LstAll";
        public const string PROC_GET_PRODUCTLANDINGPAGEBANNERLANGUAGE = "sproc_ProductLandingPageBannerLanguage_Sel";
    ...
    #region ContentModuleMapping
    public class ContentModuleMapping
    {
        //PROCEDURES 
        public const string PROC_DELETE_CONTENTMODULEMAPPING = "sproc_ContentModuleMapping_del";
        public const string PROC_UPDATE_CONTENTMODULEMAPPING = "sproc_ContentModuleMapping_ups";
        public const string PROC_GET_ALL_CONTENTMODULEMAPPING_UNASSIGN = "sproc_ContentModuleMapping_LstAll_UnAssign";
        public const string PROC_GET_ALL_CONTENTMODULEMAPPING_ASSIGN = "sproc_ContentModuleMapping_LstAll_Assign";
        public const string PROC_GET_CONTENTMODULEMAPPING = "sproc_ContentModuleMapping_Sel";
        public const string PROC_ACTIVATE_DEACTIVATE_CONTENTMODULEMAPPING = "sproc_ContentModuleMapping_Activate_Deactivate";



        //PARAMETERS
        public const string PARA_CLIENTID = "@ClientId";
        public const string PARA_CONTENTMODULEID = "@ContentModuleId";
        public const string PARA_ISACTIVE = "@IsActive";
        public const string PARA_CONTENTMODULETYPEID = "@ContentModuleTypeId";
        public const string PARA_LANGUAGEID = "@LanguageId";
        public const string PARA_FILTERTYPE = "@FilterType";
        public const string PARA_PAGE_INDEX = "@PageIndex";
        public const string PARA_PAGE_SIZE = "@PageSize";
        public const string PARA_SORT_EXP = "@SortExp";
        public const string PARA_SORT_DIR = "@SortDir";
        ...
        //FIELDS
        public const string COL_CLIENTID = "ClientId";
        public const string COL_CONTENTMODULEID = "ContentModuleId";
        public const string COL_ISACTIVE = "IsActive";
        public const string COL_CONTENTMODULETYPEID = "ContentModuleTypeId";
        public const string COL_LANGUAGEID = "LanguageId";
        public const string COL_FILTERTYPE = "FilterType";
        public const string COL_PAGE_INDEX = "PageIndex";
        public const string COL_PAGE_SIZE = "PageSize";
        public const string COL_SORT_EXP = "SortExp";
        public const string COL_SORT_DIR = "SortDir";
        public const string COL_CONTENT_MODULE_ID = "ContentModuleId";
        public const string COL_CONTENT_MODULE_NAME = "ContentModuleName";
        public const string COL_CONTENT_MODULE_ENGLISH_NAME = "ContentModuleEnglishName";
        public const string COL_CONTENT_MODULE_DESC = "ContentModuleDescription";
        ...
        public const string COL_COURSE_GROUP_ID = "CourseGroupId";
        public const string COL_IMANIFEST_URL = "ImanifestUrl";
        public const string COL_MODIFIED_ON = "LastModifiedById";
    ...
    #region UserMasterSSO
    public class UserMasterSSO
    {
        //PROCEDURES
        public const string PROC_DELETE_USERMASTERSSO = "sproc_UserMasterSSO_del";
        public const string PROC_UPDATE_USERMASTERSSO = "sproc_UserMasterSSO_ups";
        public const string PROC_GET_ALL_USERMASTERSSO = "sproc_UserMasterSSO_LstAll";
        public const string PROC_GET_USERMASTERSSO = "sproc_UserMasterSSO_Sel";

        //PARAMETERS
        public const string PARA_SYSTEMUSERGUID = "@SystemUserGUID";
        public const string PARA_SSOSYSTEMUSERGUID = "@SSOSystemUserGUID";
        public const string PARA_CLIENTID = "@ClientId";

        //FIELDS
        public const string COL_SYSTEMUSERGUID = "SystemUserGUID";
        public const string COL_SSOSYSTEMUSERGUID = "SSOSystemUserGUID";
        public const string COL_CLIENTID = "ClientId";
    }
    #endregion
    ...
    {
        //Procedure 
        public const string PROC_UPDATE_LockUnlockCurriculumAssessment = "sproc_LockUnlockCurriculumAssessment_ups";
        public const string PROC_GET_LockUnlockCurriculumAssessment = "sproc_LockUnlockCurriculumAssessment_Sel";
        public const string PROC_GET_ALL_LockUnlockCurriculumAssessment = "sproc_LockUnlockCurriculumAssessment_LstAll";
        public const string PROC_USER_UnlockCurriculumAssessment_Unlock = "sproc_UserUnlockActivityAssignment_ups_Unlock";
        public const string PROC_USER_UnlockAttemprt_Unlock = "sproc_LockUnlockAttempt_ups";
        //PARAMETERS            
        public const string PARA_LOCK_UNLOCKID = "@LockUnlockId";
        public const string PARA_SYSTEM_USER_GUID = "@SystemUserGUID";
        public const string PARA_ACTIVITY_ID = "@ActivityId";
        public const string PARA_ACTIVITY_TYPE_ID = "@ActivityTypeId";
        public const string PARA_LANGUAGE_ID = "@LanguageID";
        public const string PARA_AUTO_UNLOCKHRS = "@AutoUnLockHrs";
        public const string PARA_ADMIN_UNLOCKHRS = "@AdminUnlockHrs";
        public const string PARA_STEP = "@Step";
        public const string PARA_ISLOCK = "@IsLock";
        public const string PARA_ATTEMPT = "@Attempt";

        //FIELDS
        public const string COL_LOCK_UNLOCKID = "LockUnlockId";
        public const string COL_SYSTEMUSERGUID = "SystemUserGUID";
        public const string COL_ACTIVITY_ID = "ActivityId";
        public const string COL_ACTIVITY_TYPE_ID = "ActivityTypeId";
        public const string COL_LANGUAGE_ID = "LanguageID";
        public const string COL_AUTO_UNLOCKHRS = "AutoUnLockHrs";
        public const string COL_ADMIN_UNLOCKHRS = "AdminUnlockHrs";
        public const string COL_STEP = "Step";
        public const string COL_ISLOCK = "IsLock";
        public const string COL_ATTEMPT = "Attempt";
    }
    #endregion
    ...
    {
        //Procedure 
        public const string PROC_UPDATE_LockNumberOfAttemptsCourseAssessment = "sproc_LockNumberOfAttemptsCourseAssessment_ups";
        public const string PROC_GET_LockNumberOfAttemptsCourseAssessment = "sproc_LockNumberOfAttemptsCourseAssessment_Sel";
        public const string PROC_GET_ALL_LockNumberOfAttemptsCourseAssessment = "sproc_LockUnlockCurriculumAssessment_LstAll"; //Not Use
        public const string PROC_USER_AttemptUnlockCurriculumAssessment_Unlock = "sproc_UserAttemptUnlockActivityAssignment_ups_Unlock";
        public const string PROC_USER_LockNumberOfAttempts = "sproc_LockNumberOfAttempts_ups";
        //PARAMETERS            
        public const string PARA_LOCK_ATTEMPTID = "@LockAttemptId";
        public const string PARA_SYSTEM_USER_GUID = "@SystemUserGUID";
        public const string PARA_ACTIVITY_ID = "@ActivityId";
        public const string PARA_ACTIVITY_TYPE_ID = "@ActivityTypeId";
        public const string PARA_LANGUAGE_ID = "@LanguageID";
        public const string PARA_NO_OF_FAILED_ATTEMPT = "@NoOfFailedAttempt";
        public const string PARA_STEP = "@Step";
        public const string PARA_ISLOCK = "@IsLock";
        public const string PARA_ATTEMPT = "@Attempt";
        public const string PARA_IS_LOCK_FAILED = "@IsLockFailed";

        //FIELDS
        public const string COL_LOCK_ATTEMPTID = "LockAttemptId";
        public const string COL_SYSTEMUSERGUID = "SystemUserGUID";
        public const string COL_ACTIVITY_ID = "ActivityId";
        public const string COL_ACTIVITY_TYPE_ID = "ActivityTypeId";
        public const string COL_LANGUAGE_ID = "LanguageID";
        public const string COL_NO_OF_FAILED_ATTEMPT = "NoOfFailedAttempt";
        public const string COL_STEP = "Step";
        public const string COL_ISLOCK = "IsLock";
        public const string COL_ATTEMPT = "Attempt";
        public const string COL_IS_LOCK_FAILED = "IsLockFailed";
    }
    #endregion
    ...
    {
        //PROCEDURES
        public const string PROC_DELETE_USERCONTENTASSESSMENTINTERACTIONTRACKING = "sproc_UserContentAssessmentInteractionTracking_del";
        public const string PROC_UPDATE_USERCONTENTASSESSMENTINTERACTIONTRACKING = "sproc_UserContentAssessmentInteractionTracking_ups";
        public const string PROC_GET_ALL_USERCONTENTASSESSMENTINTERACTIONTRACKING = "sproc_UserContentAssessmentInteractionTracking_LstAll";
        public const string PROC_GET_USERCONTENTASSESSMENTINTERACTIONTRACKING = "sproc_UserContentAssessmentInteractionTracking_Sel";

        public const string PROC_UPDATE_USERCONTENTMODULEWEBAPITRACKING = "sproc_UserContentModuleWebAPITracking_ups";
        //PARAMETERS
        public const string PARA_INTERACTIONID = "@InteractionID";
        public const string PARA_SYSTEMUSERGUID = "@SystemUserGUID";
        public const string PARA_CONTENTMODULEID = "@ContentModuleId";
        public const string PARA_QUESTIONID = "@QuestionID";
        public const string PARA_QUESTIONTEXT = "@QuestionText";
        public const string PARA_OPTIONS = "@Options";
        public const string PARA_CORRECTOPTIONS = "@CorrectOptions";
        public const string PARA_USERRESPONSE = "@UserResponse";
        public const string PARA_RESULT = "@Result";

        //FIELDS
        public const string COL_INTERACTIONID = "InteractionID";
        public const string COL_SYSTEMUSERGUID = "SystemUserGUID";
        public const string COL_CONTENTMODULEID = "ContentModuleId";
        public const string COL_QUESTIONID = "QuestionID";
        public const string COL_QUESTIONTEXT = "QuestionText";
        public const string COL_OPTIONS = "Options";
        public const string COL_CORRECTOPTIONS = "CorrectOptions";
        public const string COL_USERRESPONSE = "UserResponse";
        public const string COL_RESULT = "Result";

        //PARAMETERS Second Web API
        public const string PARA_WebAPID = "@WebAPID";        
        public const string PARA_CourseName = "@CourseName";
        public const string PARA_ScreenTitle = "@ScreenTitle";
        public const string PARA_CompletionStatus = "@CompletionStatus";
        public const string PARA_UserDataXML = "@UserDataXML";
        public const string PARA_Score = "@Score";
        public const string PARA_APICount = "@APICount";
        public const string PARA_OperatingSystem = "@OperatingSystem";
        public const string PARA_Browser = "@Browser";
    }
    #endregion
    ...
    {
        //PROCEDURES
        public const string PROC_DELETE_ILTMODULEMASTER = "sproc_ILTModuleMaster_del";
        public const string PROC_UPDATE_ILTMODULEMASTER = "sproc_ILTModuleMaster_ups";
        public const string PROC_GET_ALL_ILTMODULEMASTER = "sproc_ILTModuleMaster_LstAll";
        public const string PROC_GET_ILTMODULEMASTER = "sproc_ILTModuleMaster_Sel";
        public const string PROC_GET_ALL_MOD_EVT_ILTMODULEMASTER = "sproc_ILTModuleMaster_LstAll_Mod_Event";

        //PARAMETERS
        public const string PARA_MODULEID = "@ModuleId";
        public const string PARA_EVENTID = "@EventId";
        public const string PARA_SESSIONID = "@SessionId";
        public const string PARA_DAY = "@Day";
        public const string PARA_HOURS = "@Hours";

        //FIELDS
        public const string COL_MODULEID = "ModuleId";
        public const string COL_EVENTID = "EventId";
        public const string COL_DAY = "Day";
        public const string COL_HOURS = "Hours";
        public const string COL_SESSIONID = "SessionId";

        public const string VAL_ModuleID_PREFIX = "MOD";
    }
    #endregion
    #region ILTModuleLanguageMaster
    public class ILTModuleLanguageMaster
    {
        //PROCEDURES
        public const string PROC_DELETE_ILTMODULELANGUAGEMASTER = "sproc_ILTModuleLanguageMaster_del";
        public const string PROC_UPDATE_ILTMODULELANGUAGEMASTER = "sproc_ILTModuleLanguageMaster_ups";
        public const string PROC_GET_ALL_ILTMODULELAAGUAGEMASTER = "sproc_ILTModuleLanguageMaster_LstAll";
        public const string PROC_GET_ILTMODULELANGUAGEMASTER = "sproc_ILTModuleLanguageMaster_Sel";
    ...
    {
        //PROCEDURES
        public const string PROC_DELETE_ILTMANAGEEVENTMASTER = "sproc_ILTManageEventMaster_del";
        public const string PROC_UPDATE_ILTMANAGEEVENTMASTER = "sproc_ILTManageEventMaster_ups";
        public const string PROC_GET_ALL_ILTMANAGEEVENTMASTER = "sproc_ILTManageEventMaster_LstAll";
        public const string PROC_GET_ALL_ILTUSERS = "sproc_UserWiseILTReport_Users_LstAll";
        public const string PROC_GET_ILTMANAGEEVENTMASTER = "sproc_ILTManageEventMaster_Sel";
        public const string PROC_GET_EVENT_BY_NAME = "sproc_ILTManageEventMaster_selByName";

        //PARAMETERS
        public const string PARA_EVENTID = "@EventId";
        public const string PARA_ISACTIVE = "@IsActive";
        public const string PARA_CREATEDBYNAME = "@CreatedByName";
        public const string PARA_ILTROLE = "@ILTRole";

        //FIELDS
        public const string COL_EVENTID = "EventId";
        public const string COL_ISACTIVE = "IsActive";
        public const string COL_NOOFSESSIONS = "NoOfSessions";
        public const string COL_DURATION = "Duration";
        public const string COL_ISATTENDED = "IsAttended";
        public const string COL_NOMINATIONCOUNT = "NominationCount";

        public const string VAL_EventID_PREFIX = "EVNT";
    ...
    #endregion
    #region ILTManageEventLanguageMaster
    public class ILTManageEventLanguageMaster
    {
        //PROCEDURES
        public const string PROC_DELETE_ILTMANAGEEVENTLANGUAGEMASTER = "sproc_ILTManageEventLanguageMaster_del";
        public const string PROC_UPDATE_ILTMANAGEEVENTLANGUAGEMASTER = "sproc_ILTManageEventLanguageMaster_ups";
        public const string PROC_GET_ALL_ILTMANAGEEVENTLANGUAGEMASTER = "sproc_ILTManageEventLanguageMaster_LstAll";
        public const string PROC_GET_ILTMANAGEEVENTLANGUAGEMASTER = "sproc_ILTManageEventLanguageMaster_Sel";
        ...
        public const string COL_EVENTID = "EventId";
        public const string COL_LANGUAGEID = "LanguageId";
        public const string COL_EVENTNAME = "EventName";
        public const string COL_DESCRIPTION = "Description";
        public const string COL_OBJECTIVE = "Objective";
    ...
    {
        //PROCEDURES
        public const string PROC_DELETE_ILTSESSIONMASTER = "sproc_ILTSessionMaster_del";
        public const string PROC_UPDATE_ILTSESSIONMASTER = "sproc_ILTSessionMaster_ups";
        public const string PROC_UPDATE_ILTSESSIONMASTER_BULKIMPORT = "sproc_ILTSessionMaster_ups_BulkImport";
       // public const string PROC_CANCEL_ILTSESSION = "sproc_CancelILTSession_ups";
        public const string PROC_CANCEL_ILTSESSION = "sproc_ILTSessionCancel_ups";
        public const string PROC_USERCANCEL_ILTSESSION = "sproc_ILTUserSessionCancel_ups";
        public const string PROC_GET_EMAIL = "sproc_ILTGet_Admin_Learner_EmailID";

        public const string PROC_USERINTREST_ILTSESSION = "sproc_ILTUserIntrestSession_ups";
        public const string PROC_ILTSessionDetails = "sproc_ILTSessionDetails";
        public const string PROC_GET_ILTSessionID = "sproc_getILTSessionID";

        public const string PROC_GET_ALL_ILTSESSIONMASTER = "sproc_ILTSessionMaster_LstAll";
        public const string PROC_GET_ILTSESSIONMASTER = "sproc_ILTSessionMaster_Sel";
        public const string PROC_GET_ALL_SESN_EVT_ILTSESSIONMASTER = "sproc_ILTSessionMaster_LstAll_Sesn_Event";
        public const string PROC_GET_ALL_ILTSESSIONMASTER_BULKIMPORT = "sproc_ILTSessionMaster_LstAll_BulkImport";
        public const string PROC_GET_RULES = "sproc_RuleMaster_LstAll_NotInActivity";
        public const string PROC_GET_ROLE_USERS = "sproc_UserMaster_sel_RuleUsers";
        public const string PROC_GET_SESSION_BY_NAME = "sproc_ILTSessionMaster_selByName";
        public const string PROC_GET_MAXNO_ILTSESSIONMASTER = "sproc_ILTSessionMaster_MaxNo";
        public const string PROC_GET_AVAILABLESESSION = "sproc_ILTSessionavailable_LstAll";
        public const string PROC_GET_REGISTEREDSESSION = "sproc_ILTRegisteredSession_LstAll";
        public const string PROC_GET_COMPLETEDSESSION = "sproc_ILTCompletedSession_LstAll";
        public const string PROC_GET_MODELREFERENCEDETAILS = "sproc_ILTModuleReferenceDetails_sel";
        public const string PROC_GET_MODULEDETAILS = "sproc_ILTModuleDetails_sel";
        public const string PROC_GET_MODULDETAILSREPORT = "sproc_Report_Module_Details";
        public const string PROC_GET_TRAININGATTENDANCEREPORT = "sproc_Report_TrainingAttendance";
        public const string PROC_GET_USERWISEILTREPORT = "sproc_Report_User_Wise_ILT_Details";
        public const string PROC_GET_ALL_INSTRUCTOR = "sproc_ILTInstructor_LstAll";
        ...
        public const string PARA_SESSIONID = "@SessionId";
        public const string PARA_EVENTID = "@EventId";
        public const string PARA_SESSIONNO = "@SessionNo";
        public const string PARA_TOTALSESSIONDURATION = "@TotalSessionDuration";
        public const string PARA_STARTDATE = "@StartDate";
        public const string PARA_STARTDATEFROM = "@StartDateFrom";
        public const string PARA_STARTDATETO = "@StartDateTo";
        public const string PARA_ENDDATE = "@EndDate";
        public const string PARA_ENDDATEFROM = "@EndDateFrom";
        public const string PARA_ENDDATETO = "@EndDateTo";
        public const string PARA_SESSIONSTATUS = "@SessionStatus";
        public const string PARA_LASTDATEOFNOMINATION = "@LastDateofNomination";
        public const string PARA_LASTDATEOFCANCELLATION = "@LastDateofCancellation";
        public const string PARA_PREFERREDTIMEZONE = "@TimeZone";
        public const string PARA_LOCATIONID = "@LocationId";
        public const string PARA_PRIMARYINSTRUCTORID = "@PrimaryInstructorId";
        public const string PARA_SECONDARYINSTRUCTORID = "@SecondaryInstructorId";
        public const string PARA_MINREGISTRATION = "@MinRegistration";
        public const string PARA_TOTALSEATSAVAILABLE = "@TotalSeatsAvailable";
        public const string PARA_RECURRINGREMINDERFROM = "@RecurringReminderfrom";
        public const string PARA_RECURRINGREMINDERDATE = "@RecurringReminderDate";
        public const string PARA_ALLOWSELFREGISTRATION = "@AllowSelfRegistration";
        public const string PARA_REGISTRATIONBYADMIN = "@RegistrationByAdmin";
        public const string PARA_SELFREG_REGBYADMIN = "@SelfRegistrationAndRegistrationByAdmin";
        public const string PARA_SELFREGISTRATIONLIMIT = "@SelfRegistrationLimit";
        public const string PARA_AUTOAPPROVAL = "@AutoApproval";
        public const string PARA_ADMINAPPROVAL = "@AdminApproval";
        public const string PARA_ISSESSIONCANCEL = "@IsSessionCancel";
        public const string PARA_ISACTIVE = "@IsActive";
        public const string PARA_SYSTEMUSERGUID = "@SystemUserGUID";
        ...
        public const string COL_SESSIONNO = "SessionNo";
        public const string COL_REGISTRATIONTYPE = "RegistrationType";
        public const string COL_TOTALSEATESAVAILABLE = "TotalSeatsAvailable";
        public const string COL_REGISTEREDSEATES = "RegisteredSeats";
        public const string COL_SEATAVAILABLE = "SeatAvailable";
        public const string COL_MINREGISTRATION = "MinRegistration";
        public const string COL_WAIT_INTEREST_LIST = "Wait_Interest_List";
        public const string COL_LANGUAGEID = "LanguageId";
        public const string COL_LOCATIONID = "LocationId";
        public const string COL_LOCATIONNAME = "LocationName";
        public const string COL_LOCATIONVENUE = "LocationVenue";
        public const string COL_PRIMARYINSTRUCTORID = "PrimaryInstructorId";
        public const string COL_PRIMARYINSTRUCTORNAME = "PrimaryInstructorName";
        public const string COL_PRIMARYINSTRUCTOREMAIL = "PrimaryInstructorEmail";
        public const string COL_PRIMARYINSTRUCTORLOGINID = "PrimaryInstructorLoginID";
        public const string COL_TIMEZONE = "TimeZone";
        public const string COL_LASTDATEOFNOMINATION = "LastDateofNomination";
        public const string COL_LASTDATEOFCANCELLATION = "LastDateofCancellation";
        public const string COL_TOTALSESSIONDURATION = "TotalSessionDuration";
        public const string COL_RECURRINGREMINDERFROM = "RecurringReminderfrom";
        public const string COL_RECURRINGREMINDERDATE = "RecurringReminderDate";
        public const string COL_ALLOWSELFREGISTRATION = "AllowSelfRegistration";
        public const string COL_REGISTRATIONBYADMIN = "RegistrationByAdmin";
        public const string COL_SELFREG_REGBYADMIN = "SelfRegistrationAndRegistrationByAdmin";
        public const string COL_SELFREGISTRATIONLIMIT = "SelfRegistrationLimit";
        public const string COL_AUTOAPPROVAL = "AutoApproval";
        public const string COL_ADMINAPPROVAL = "AdminApproval";
        public const string COL_ISSESSIONCANCEL = "IsSessionCancel";
        public const string COL_ISACTIVE = "IsActive";
        public const string COL_NOOFMODULES = "NoOfModules";
        public const string COL_MAXSESSIONNO = "MaxSessionNo";
        ...
        public const string COL_ModuleName = "ModuleName";
        public const string COL_ModuleDay = "Day";

        public const string COL_DocumentName = "DocumentName";
        public const string COL_FileName = "FileName";
        public const string COL_REFMATERIALID= "RefMaterialId";
        public const string COL_MARKATTENDANCE = "MarkAttendance";
        public const string COL_ILTMARKATTENDANCE = "ILTMarkAttendance";
        public const string COL_UserName = "UserName";
        public const string COL_UserId = "UserId";
        public const string COL_EMAILID = "EmailId";
        public const string COL_INSTRUCTOREMAIL = "InstructorEmail";

        // Prefix
        public const string VAL_SessionID_PREFIX = "SESN";
    }
    #endregion
    #region ILTSessionLanguageMaster
    public class ILTSessionLanguageMaster
    {
        //PROCEDURES
        public const string PROC_DELETE_ILTSESSIONLANGUAGEMASTER = "sproc_ILTSessionLanguageMaster_del";
        public const string PROC_UPDATE_ILTSESSIONLANGUAGEMASTER = "sproc_ILTSessionLanguageMaster_ups";
        public const string PROC_GET_ALL_ILTSESSIONLANGUAGEMASTER = "sproc_ILTSessionLanguageMaster_LstAll";
        public const string PROC_GET_ILTSESSIONLANAGUAGEMASTER = "sproc_ILTSessionLanguageMaster_Sel";
        ...
        public const string PARA_SESSIONNAME = "@SessionName";
        public const string PARA_SYSTEMUSERGUID = "@SystemUserGUID";
        public const string PARA_SESSIONDESCRIPTION = "@SessionDescription";
        public const string PARA_SESSIONPREWORK = "@SessionPreWork";
        public const string PARA_SESSIONPOSTWORK = "@SessionPostWork";
        public const string PARA_STATUS = "@Status";
        ...
        public const string COL_LANGUAGEID = "LanguageId";
        public const string COL_SESSIONNAME = "SessionName";        
        public const string COL_SESSIONDESCRIPTION = "SessionDescription";
        public const string COL_SESSIONPREWORK = "SessionPreWork";
        public const string COL_SESSIONPOSTWORK = "SessionPostWork";
        public const string COL_SESSIONINTEREST = "Interest";
    }
    #endregion

    #region SessionModuleAllocatedResources
    public class SessionModuleAllocatedResources
    {
        //PROCEDURES
        public const string PROC_DELETE_SESSIONMODULEALLOCATEDRESOURCES = "sproc_ILTSessionModuleAllocatedResources_del";
        public const string PROC_UPDATE_SESSIONMODULEALLOCATEDRESOURCES = "sproc_ILTMSessionModuleAllocatedResources_ups";
        public const string PROC_GET_ALL_SESSIONMODULEALLOCATEDRESOURCES = "sproc_ILTSessionModuleAllocatedResources_LstAll";
        public const string PROC_GET_SESSIONMODULEALLOCATEDRESOURCES = "sproc_ILTSessionModuleAllocatedResources_sel";
        public const string PROC_GET_SESSIONMODULEALLOCATEDRESOURCESBYID = "sproc_ILTSessionModuleAllocatedResourcesByID_sel";
        public const string PROC_GET_ALL_SESSIONMAPPEDMODULEALLOCATEDRESOURCES = "sproc_ILTMappedSessionModuleAllocatedResources_LstAll";
    ...
    {
        //PROCEDURES
        public const string PROC_DELETE_ILTNOMINATIONMASTER = "sproc_ILTNominationMaster_del";
        public const string PROC_UPDATE_ILTNOMINATIONMASTER = "sproc_ILTNominationMaster_ups";
        public const string PROC_GET_ALL_USERS_FOR_NOMINATION = "sproc_ILTNominationMaster_Users_LstAll";
        public const string PROC_GET_ALL_REGISTERED_USERS_FOR_NOMINATION = "sproc_ILTNominationMaster_Registered_Users_LstAll";
        public const string PROC_GET_ALL_INTERESTED_USERS_FOR_NOMINATION = "sproc_ILTNominationMaster_Interested_Users_LstAll";

        //PARAMETERS
        public const string PARA_SESSION_REGISTRATION_ID = "@SessionRegistrationId";
        public const string PARA_MODULEID = "@ModuleId";
        public const string PARA_EVENTID = "@EventId";
        public const string PARA_SESSIONID = "@SessionId";
        public const string PARA_LANGUAGEID = "@LanguageId";
        public const string PARA_USER_ID = "@SystemUserGUID";
        public const string PARA_STATUS = "@Status";
        public const string PARA_MESSAGE = "@Message";
        public const string PARA_NOMINATED_BYID = "@NominatedById";
        public const string PARA_NOMINATED_DATE = "@NominatedDate";
        public const string PARA_INTRESTED_DATE = "@InterestedDate";
        public const string PARA_USER_CANCEL_DATE = "@UserCancelDate";
        public const string PARA_ISSESSION_CANCEL = "@IsSessionCancel";

        //FIELDS
        public const string COL_SESSION_REGISTRATION_ID = "SessionRegistrationId";
        public const string COL_MODULEID = "ModuleId";
        public const string COL_EVENTID = "EventId";
        public const string COL_SESSIONID = "SessionId";
        public const string COL_LANGUAGEID = "LanguageId";
        ...
        public const string COL_EMAIL_ID = "EmailId";
        public const string COL_IS_ACTIVE = "IsActive";
        public const string COL_NOMINATED_DATE = "NominatedDate";
        public const string COL_INTERESTED_DATE = "InterestedDate";
        public const string COL_NOMINATED_TIME = "NominatedTime";
        public const string COL_INTERESTED_TIME = "InterestedTime";
        public const string VAL_SessionRegistrationID_PREFIX = "SREG";
    }
    #endregion
    ...
    {
        //PROCEDURES
        public const string PROC_GET_EVENT_DETAILS = "sproc_ILTAttendanceMaster_Event_Sel";
        public const string PROC_GET_SESSION_DETAILS = "sproc_ILTAttendanceMaster_Session_Sel";
        public const string PROC_GET_ALL_SESSION_LIST = "sproc_ILTAttendanceMaster_Session_LstAll";
        public const string PROC_GET_ALL_MODULE_DETAILS = "sproc_ILTAttendanceMaster_Module_LstAll";
        public const string PROC_GET_ALL_USERS_MARK_ATNDNC_SESSION = "sproc_ILTAttendanceMaster_MarkAtndncUsers_Session_LstAll";
        public const string PROC_GET_ALL_USERS_MARK_ATNDNC_MODULE = "sproc_ILTAttendanceMaster_MarkAtndncUsers_Module_LstAll";
        public const string PROC_UPDATE_EVENT_ILTATTENDANCEMASTER = "sproc_ILTAttendanceMaster_MarkAll_Event_ups";
        public const string PROC_UPDATE_SESSION_ILTATTENDANCEMASTER = "sproc_ILTAttendanceMaster_MarkAll_Session_ups";
        public const string PROC_UPDATE_INDIVIDUAL_SESSION_ILTATTENDANCEMASTER = "sproc_ILTAttendanceMaster_Individual_Session_ups";
        public const string PROC_UPDATE_INDIVIDUAL_MODULE_ILTATTENDANCEMASTER = "sproc_ILTAttendanceMaster_Individual_Module_ups";
        ...
        public const string PARA_MODULEID = "@ModuleId";
        public const string PARA_USER_ID = "@SystemUserGUID";
        public const string PARA_MARK_ATTENDANCE = "@MarkAttendance";
        public const string PARA_ATTENDANCE_DATE = "@AttendanceDate";
        public const string PARA_ATTENDANCE_TIME = "@AttendanceTime";
        public const string PARA_MESSAGE = "@Message";
        public const string PARA_ILTROLE = "@ILTRole";
        ...
        public const string COL_MODULE_NAME = "ModuleName";
        public const string COL_INSTRUCTOR_NAME = "InstructorName";
        public const string COL_ATTENDANCE_DATE = "AttendanceDate";
        public const string COL_ATTENDANCE_TIME = "AttendanceTime";
        public const string COL_ISATTENDED = "IsAttended";
        public const string COL_MARK_ATTENDANCE = "MarkAttendance";
        public const string COL_DAY = "Day";
        public const string COL_LANGUAGEID = "LanguageId";
        public const string COL_USER_ID = "SystemUserGUID";
        public const string COL_USER_NAME_ALIAS = "UserNameAlias";
        ...
        public const string COL_EMAIL_ID = "EmailId";
        public const string COL_IS_ACTIVE = "IsActive";
        public const string COL_SESSION_COUNT = "SessionCount";
        public const string COL_MESSAGE = "Message";

        public const string VAL_EventID_PREFIX = "ATNDC";
    }
    #endregion
}
