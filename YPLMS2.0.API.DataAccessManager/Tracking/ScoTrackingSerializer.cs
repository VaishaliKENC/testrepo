...
namespace YPLMS2._0.API.DataAccessManager
{
    public class ScoTrackingSerializer : ILessonTrackingSerializer
    {
        ...
        public string WriteLessonTrackingConvert(LessonTracking t)
        {

            var lessonTracking = new Dictionary<string,LessonTracking>();
            var xDoc = new XDocument(new XElement("Root",
                        new XElement("sco", new XAttribute("identifier", t.Identifier),
                        new XElement("cmi",
                            new XElement("core",
                                new XElement("student_id", new XCData(t.StudentId)),
                                new XElement("student_name", new XCData(t.StudentName)),
        ...
        public LessonTracking ParseLesson(XmlNode lessonNode)
        {
            ...
            return new LessonTracking
            {
                ...
                totalpages = snagInt("core/totalpages"),
                completedpages = snagInt("core/completedpages")
            };
        }
