...
{
   [Serializable] public class CurriculumTracking :BaseEntity
    {
        /// <summary>
        /// Default Contructor
        /// <summary>
        public CurriculumTracking()
        { }
        ...
        public string CurriculumId
        {
            ...
            set { if (this._curriculumId != value) { _curriculumId = value; } }
        }
        ...
        public new enum Method
        {
            ...
            DeleteAdminCurriculumTracking,
            DeleteAdminPreviewTracking,
            GetStatus
        }
        ...
        {
            get { return _userID; }
            set { if (this._userID != value) { _userID = value; } }
        }
