...
{
    [Serializable]
   public class QuestionOptions : QuestionnaireOptionsLanguage
    {
        /// <summary>
        /// Default Contructor
        /// <summary>
        ...
        public enum QuestionnaireOptionType
        {
            Preferred = 1,
            Non_Preferred = 2,
            Neutral = 3
        ...
        private QuestionnaireOptionType _optionType;
        public QuestionnaireOptionType OptionType
        {
