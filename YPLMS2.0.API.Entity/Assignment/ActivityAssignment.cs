   ...
   public class ActivityAssignment : BaseEntity
    {
        ...
        public new enum ListMethod
        {
            ...
            GetUserAssignmentsForUnlock,
            GetUserAssignmentsForAttemptUnlock,
            FindActivityForAssignment,
            FindActivityListForDelequencyHistory,
            FindActivityListForInteractionTracking,
            ...
            GetAssignmentListForDL,
            GetCurrentAttemptsForMaxCourseScore,
            GetAllActivityByActivityCertificateMapping,
            GetVirtualClassroomNominationDetailsDuringOneTimeAssignment,
          FindActivityForAssignment_ForCurriculum,
          Delete_VT_CT_AtTimeOf_EditAssignment,
          GetVirtualClassroomNominationRegistrationCountOneTimeAssignment,
          SendActivitiesForCertificationApproval,
          GetAllCertificationPrograms,
           GetAllCertificationProgramsFromLearner,
           AddAllReRgister
        ...
        public new enum Method
        {
            ...
            GetCoursesCount,
            Get_AssignmentForBulkImport,
           GetActivity,
           UpdateCertificationPrograms
        }
        ...
        private string _OperationModeForBulkAssignment;
        ...
        //private bool _bIsCertificationProgram;
        ...
        //}
        private int businessRuleSelectedIndex;
        public int BusinessRuleSelectedIndex
        {
            get { return businessRuleSelectedIndex; }
            set { businessRuleSelectedIndex = value; }
        }
        public bool EmailScheduleDelivery { get; set; }
        public bool IsReassignmentChecked { get; set; }
        public bool IsMailChecked { get; set; }
        public bool IsAutoMail { get; set; }
        public string BusinessRuleSelectedValue { get; set; }
