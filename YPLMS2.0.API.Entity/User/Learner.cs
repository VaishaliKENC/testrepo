...
namespace YPLMS2._0.API.Entity
{
     ...
     public class Learner : BaseEntity
    {
        ...
        {            
            ...
            _entListUserAdminRole = new List<UserAdminRole>();
        }
        ...
        public new enum Method
        {
            ...
            GetUserForReqById,
            CheckUserByAlias,
            GetUserDetailsByTypeID,
            GetUserByTypeId,
            GetUserByAlias,
            GetUserByAliasForForgotPassword,
            GetUserByEmail,
            Get,
            GetSelfRegiUser,
            GetSSOLOGIN,
            ...
            UpdateDBIndex,
            SyncBRUsersOnImport,
            SetInitialSettingsOnImport,
            UpdateProfile,
            GetUserByEmailUpdateProfile,
            GetUserScope,
            UpdateDateFormat,
            ...
            GetIsUserLock,
            GetOTPNumber,
            CheckStudentIsApproved,
            AddSubscriptionOfUserForNewsLetter,
            UpdateUserCustomField,
            UpdateTermsAndCondition,
            ValidateResetPassword,
            GetActiveUserEmail,
            GetUserBySystemUserGUID,
            GetUserByAliasILT
        }
        /// <summary>
        /// List method ENUM
        ...
        public new enum ListMethod
        {
            ...
            OneTimeUserList,
            GetBulkImport,
            GetAllForAssessmentCourse,
            GetAllAttendeeList,
            GetAllUserSubscribeForNewsLetter,
            BulkUsersPasswordReset,
        }
       ...
       /// </summary>
        ...
        public virtual bool Validate(bool pIsUpdate)
        {
            if (pIsUpdate)
            {
        ...
        /// <summary>
        /// To check the current user is Site Admin 
        /// </summary>
        /// <returns></returns>
        public bool IsSiteAdmin()
        {
            UserAdminRole entAdminRoleReturn = this.UserAdminRole.Find(delegate (UserAdminRole entRole)
            { return entRole.RoleId == AdminRole.SITE_ADMIN_ROLE_ID; });
            if (entAdminRoleReturn != null)
                return true;
            else
                return false;
        }
        ...
        /// <summary>
        /// To check the current user is Product Admin 
        /// </summary>
        /// <returns></returns>
        public bool IsProductAdmin()
        {
            UserAdminRole entAdminRoleReturn = this.UserAdminRole.Find(delegate (UserAdminRole entRole)
            { return entRole.RoleId == AdminRole.PRODUCT_ADMIN_ROLE_ID; });
            if (entAdminRoleReturn != null)
                return true;
            else
                return false;
        ...
        /// <summary>
        /// to Check the current user Is Super Admin
        /// </summary>
        /// <returns></returns>
        public bool IsSuperAdmin()
        {
            UserAdminRole entAdminRoleReturn = this.UserAdminRole.Find(delegate(UserAdminRole entRole)
            { return entRole.RoleId == AdminRole.SUPER_ADMIN_ROLE_ID;});
            if (entAdminRoleReturn != null)
                return true;
            else
                return false;
        ...
        {
            UserAdminRole entAdminRoleReturn = this.UserAdminRole.Find(delegate (UserAdminRole entRole)
            { return entRole.RoleId == AdminRole.CONTENT_ADMIN_ROLE_ID; });
            if (entAdminRoleReturn != null)
                return true;
            else
                return false;
        ...
        /// <summary>
        /// To Check the current user Is ILT Instructor
        /// </summary>
        /// <returns></returns>
        public bool IsILTInstructor()
        {
            UserAdminRole entAdminRoleReturn = this.UserAdminRole.Find(delegate (UserAdminRole entRole)
            { return entRole.RoleId == AdminRole.GRSI_ILT_INSTRUCTOR_ROLE_ID; });
            if (entAdminRoleReturn != null)
                return true;
            else
                return false;
        ...
        /// <summary>
        /// To Check the current user Is Mortgage Site Admin
        /// </summary>
        /// <returns></returns>
        public bool IsMortgageSiteAdmin()
        {
            UserAdminRole entAdminRoleReturn = this.UserAdminRole.Find(delegate (UserAdminRole entRole)
            { return entRole.RoleId == AdminRole.MORTGAGE_SITE_ADMIN_ROLE_ID; });
            if (entAdminRoleReturn != null)
                return true;
            else
                return false;
        ...
        /// <summary>
        /// to check report admin
        /// </summary>
        /// <returns></returns>
        public bool IsReportAdmin()
        {
            UserAdminRole entAdminRoleReturn = this.UserAdminRole.Find(delegate (UserAdminRole entRole)
            { return entRole.RoleId == AdminRole.REPORT_ADMIN_ROLE_ID; });
            if (entAdminRoleReturn != null)
                return true;
            else
                return false;
        ...
        /// </summary>
        /// <returns></returns>
        public bool IsSMEAdmin()
        {
            UserAdminRole entAdminRoleReturn = this.UserAdminRole.Find(delegate (UserAdminRole entRole)
            { return entRole.RoleId == AdminRole.SME_ADMIN_ROLE_ID; });
            if (entAdminRoleReturn != null)
                return true;
            else
                return false;
